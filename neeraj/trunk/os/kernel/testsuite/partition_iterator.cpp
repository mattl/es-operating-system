...
void Test(es::Context* context)
{
    ...
    CreatePartition(context, "partition0", size, 0x01);
    size = 16 * 1024 * 1024LL;
    CreatePartition(context, "extended", size, 0x04);
    size = 4 * 1024 * 1024LL;
    CreatePartition(context, "partition1", size, 0x01);
    size = 4 * 1024 * 1024LL;
    CreatePartition(context, "partition2", size, 0x01);
    size = 8 * 1024 * 1024LL;
    CreatePartition(context, "logical0", size, 0x04);
    size = 8 * 1024 * 1024LL;
    CreatePartition(context, "logical1", size, 0x04);
