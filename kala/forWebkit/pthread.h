...
#if !defined(__rtems__) && !defined(__es__)
...
int _EXFUN(pthread_mutexattr_gettype,
    (__const pthread_mutexattr_t *__restrict __attr, int *__restrict __kind));
...
// For Webkit tmp pass
int     _EXFUN(pthread_cond_init,
        (pthread_cond_t *__restrict __cond, _CONST pthread_condattr_t
	*__restrict __attr));

int     _EXFUN(pthread_cond_destroy,(pthread_cond_t *__cond));
int     _EXFUN(pthread_cond_signal,(pthread_cond_t *__cond));
int     _EXFUN(pthread_cond_broadcast,(pthread_cond_t *__cond));
...
int     _EXFUN(pthread_cond_timedwait,
        (pthread_cond_t *__restrict __cond, pthread_mutex_t *__restrict	__mutex,
	_CONST struct timespec *__restrict __abstime));
