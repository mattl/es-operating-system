...
void TestSetSize(es::Context* context)
{
...
void TestSetSize2(es::Context* context)
{
    Handle<es::Stream> stream;
...
void TestWrite(es::Context* context)
{
    Handle<es::Stream> stream;
    stream = context->lookup("partition1");
    long long size;
...
void TestBind(es::Context* context)
{
    Handle<es::Binding> binding;
...
void RemoveLogicalAndExtendedPartitions(es::Context* context)
{
