/* Automatically generated from Squeak on #(4 July 2005 4:07:38 pm) */
...
int addNewMethodToCache(void) {
	...
	primitiveFunctionPointer = ((int) (primitiveTable[primitiveIndex]));
	for (p = 0; p <= (CacheProbeMax - 1); p += 1) {
		...
		if ((methodCache[probe + MethodCacheSelector]) == 0) {
			...
			methodCache[probe + MethodCachePrimFunction] = primitiveFunctionPointer;
			return null;
		}
	}
...
int allocateChunk(int byteSize) {
	...
	if ((((unsigned ) ((longAt(freeBlock)) & AllButTypeMask))) >= (((unsigned ) minFree))) {
		enoughSpace = 1;
		goto l1;
	} else {
...
l1:	/* end sufficientSpaceToAllocate: */;
	...
	if ((((unsigned ) ((longAt(freeBlock)) & AllButTypeMask))) < (((unsigned ) (byteSize + BaseHeaderSize)))) {
		error("out of memory");
	}
...
int allocateOrRecycleContext(int needsLarge) {
	...
	if (needsLarge == 0) {
		if (freeContexts != NilContext) {
			cntxt = freeContexts;
			freeContexts = longAt(((((char *) cntxt)) + BaseHeaderSize) + (0 << 2));
			return cntxt;
		}
	} else {
		if (freeLargeContexts != NilContext) {
			cntxt = freeLargeContexts;
			freeLargeContexts = longAt(((((char *) cntxt)) + BaseHeaderSize) + (0 << 2));
			return cntxt;
		}
	}
	if (needsLarge == 0) {
		cntxt = instantiateContextsizeInBytes(longAt(((((char *) specialObjectsOop)) + BaseHeaderSize) + (ClassMethodContext << 2)), SmallContextSize);
	} else {
		cntxt = instantiateContextsizeInBytes(longAt(((((char *) specialObjectsOop)) + BaseHeaderSize) + (ClassMethodContext << 2)), LargeContextSize);
	}
	longAtput(((((char *) cntxt)) + BaseHeaderSize) + (4 << 2), nilObj);
	return cntxt;
}
...
int asciiOfCharacter(int characterObj) {
	...
	if (ccIndex == 0) {
		...
		cl = longAt(((((char *) (longAt(((((char *) specialObjectsOop)) + BaseHeaderSize) + (CompactClasses << 2))))) + BaseHeaderSize) + ((ccIndex - 1) << 2));
	}
	/* begin success: */
	successFlag = (cl == (longAt(((((char *) specialObjectsOop)) + BaseHeaderSize) + (ClassCharacter << 2)))) && successFlag;
...
int becomewithtwoWaycopyHash(int array1, int array2, int twoWayFlag, int copyHashFlag) {
	...
	l4:	/* end lastPointerOf: */;
		...
		fwdBlock2 = ((endOfMemory + BaseHeaderSize) + 7) & 4294967288U;
		fwdBlock2 += 16;
...
int characterForAscii(int ascii) {
	return longAt(((((char *) (longAt(((((char *) specialObjectsOop)) + BaseHeaderSize) + (CharacterTable << 2))))) + BaseHeaderSize) + (ascii << 2));
}

int characterTable(void) {
	return longAt(((((char *) specialObjectsOop)) + BaseHeaderSize) + (CharacterTable << 2));
}
...
int checkForInterrupts(void) {
	...
	if (signalLowSpace) {
		...
		signalLowSpace = 0;
		sema = longAt(((((char *) specialObjectsOop)) + BaseHeaderSize) + (TheLowSpaceSemaphore << 2));
		if (!(sema == nilObj)) {
	...
	if (interruptPending) {
		...
		interruptPending = 0;
		sema = longAt(((((char *) specialObjectsOop)) + BaseHeaderSize) + (TheInterruptSemaphore << 2));
		if (!(sema == nilObj)) {
			synchronousSignal(sema);
		}
	}
	if (nextWakeupTick != 0) {
		...
		if (now >= nextWakeupTick) {
			...
			nextWakeupTick = 0;
			sema = longAt(((((char *) specialObjectsOop)) + BaseHeaderSize) + (TheTimerSemaphore << 2));
			if (!(sema == nilObj)) {
				synchronousSignal(sema);
			}
		}
	...
	if (pendingFinalizationSignals > 0) {
		sema = longAt(((((char *) specialObjectsOop)) + BaseHeaderSize) + (TheFinalizationSemaphore << 2));
		if ((fetchClassOf(sema)) == (longAt(((((char *) specialObjectsOop)) + BaseHeaderSize) + (ClassSemaphore << 2)))) {
			synchronousSignal(sema);
		}
	...
	if ((semaphoresToSignalCountA > 0) || (semaphoresToSignalCountB > 0)) {
		...
		xArray = longAt(((((char *) specialObjectsOop)) + BaseHeaderSize) + (ExternalObjectsArray << 2));
		...
		if (semaphoresUseBufferA) {
			for (i = 1; i <= semaphoresToSignalCountB; i += 1) {
				...
				if (index <= xSize) {
					...
					if ((fetchClassOf(sema1)) == (longAt(((((char *) specialObjectsOop)) + BaseHeaderSize) + (ClassSemaphore << 2)))) {
...
int classArray(void) {
	return longAt(((((char *) specialObjectsOop)) + BaseHeaderSize) + (ClassArray << 2));
}

int classBitmap(void) {
	return longAt(((((char *) specialObjectsOop)) + BaseHeaderSize) + (ClassBitmap << 2));
}

int classByteArray(void) {
	return longAt(((((char *) specialObjectsOop)) + BaseHeaderSize) + (ClassByteArray << 2));
}

int classCharacter(void) {
	return longAt(((((char *) specialObjectsOop)) + BaseHeaderSize) + (ClassCharacter << 2));
}

int classExternalAddress(void) {
	return longAt(((((char *) specialObjectsOop)) + BaseHeaderSize) + (ClassExternalAddress << 2));
}

int classExternalData(void) {
	return longAt(((((char *) specialObjectsOop)) + BaseHeaderSize) + (ClassExternalData << 2));
}

int classExternalFunction(void) {
	return longAt(((((char *) specialObjectsOop)) + BaseHeaderSize) + (ClassExternalFunction << 2));
}

int classExternalLibrary(void) {
	return longAt(((((char *) specialObjectsOop)) + BaseHeaderSize) + (ClassExternalLibrary << 2));
}

int classExternalStructure(void) {
	return longAt(((((char *) specialObjectsOop)) + BaseHeaderSize) + (ClassExternalStructure << 2));
}

int classFloat(void) {
	return longAt(((((char *) specialObjectsOop)) + BaseHeaderSize) + (ClassFloat << 2));
}

int classLargeNegativeInteger(void) {
	return longAt(((((char *) specialObjectsOop)) + BaseHeaderSize) + (ClassLargeNegativeInteger << 2));
}

int classLargePositiveInteger(void) {
	return longAt(((((char *) specialObjectsOop)) + BaseHeaderSize) + (ClassLargePositiveInteger << 2));
}
...
int classPoint(void) {
	return longAt(((((char *) specialObjectsOop)) + BaseHeaderSize) + (ClassPoint << 2));
}

int classSemaphore(void) {
	return longAt(((((char *) specialObjectsOop)) + BaseHeaderSize) + (ClassSemaphore << 2));
}

int classSmallInteger(void) {
	return longAt(((((char *) specialObjectsOop)) + BaseHeaderSize) + (ClassInteger << 2));
}

int classString(void) {
	return longAt(((((char *) specialObjectsOop)) + BaseHeaderSize) + (ClassString << 2));
}
...
l2:	/* end sufficientSpaceToAllocate: */;
	...
	if ((((unsigned ) ((longAt(freeBlock)) & AllButTypeMask))) < (((unsigned ) (bytes + BaseHeaderSize)))) {
		error("out of memory");
	}
...
int commonAt(int stringy) {
	...
	if ((messageSelector == (longAt(((((char *) (longAt(((((char *) specialObjectsOop)) + BaseHeaderSize) + (SpecialSelectors << 2))))) + BaseHeaderSize) + ((16 * 2) << 2)))) && (lkupClass == (fetchClassOfNonInt(rcvr)))) {
		...
		if (successFlag) {
			/* begin pop:thenPush: */
			longAtput(sp = stackPointer - (((argumentCount + 1) - 1) * 4), result);
			stackPointer = sp;
			return null;
		}
	}
	...
	if (successFlag) {
		if (stringy) {
			result = longAt(((((char *) (longAt(((((char *) specialObjectsOop)) + BaseHeaderSize) + (CharacterTable << 2))))) + BaseHeaderSize) + (((result >> 1)) << 2));
		}
		/* begin pop:thenPush: */
		longAtput(sp1 = stackPointer - (((argumentCount + 1) - 1) * 4), result);
		stackPointer = sp1;
		return null;
	}
}
...
int commonAtPut(int stringy) {
	...
	if ((messageSelector == (longAt(((((char *) (longAt(((((char *) specialObjectsOop)) + BaseHeaderSize) + (SpecialSelectors << 2))))) + BaseHeaderSize) + ((17 * 2) << 2)))) && (lkupClass == (fetchClassOfNonInt(rcvr)))) {
		...
		if (successFlag) {
			/* begin pop:thenPush: */
			longAtput(sp = stackPointer - (((argumentCount + 1) - 1) * 4), value);
			stackPointer = sp;
			return null;
		}
	}
	...
	if (successFlag) {
		/* begin pop:thenPush: */
		longAtput(sp1 = stackPointer - (((argumentCount + 1) - 1) * 4), value);
		stackPointer = sp1;
		return null;
	}
}
...
int commonVariableatcacheIndex(int rcvr, int index, int atIx) {
	...
	if (((((unsigned ) index)) >= 1) && ((((unsigned ) index)) <= (((unsigned ) stSize)))) {
		...
		if (fmt >= 16) {
			return longAt(((((char *) (longAt(((((char *) specialObjectsOop)) + BaseHeaderSize) + (CharacterTable << 2))))) + BaseHeaderSize) + ((byteAt(((((char *) rcvr)) + BaseHeaderSize) + (index - 1))) << 2));
		} else {
...
int createActualMessageTo(int aClass) {
	...
	argumentArray = instantiateClassindexableSize(longAt(((((char *) specialObjectsOop)) + BaseHeaderSize) + (ClassArray << 2)), argumentCount);
	/* begin pushRemappableOop: */
	remapBuffer[remapBufferCount += 1] = argumentArray;
	message = instantiateClassindexableSize(longAt(((((char *) specialObjectsOop)) + BaseHeaderSize) + (ClassMessage << 2)), 0);
	/* begin popRemappableOop */
...
int displayBitsOfLeftTopRightBottom(int aForm, int l, int t, int r, int b) {
	...
	displayObj = longAt(((((char *) specialObjectsOop)) + BaseHeaderSize) + (TheDisplay << 2));
	if (!(aForm == displayObj)) {
		return null;
	}
	/* begin success: */
...
int displayObject(void) {
	return longAt(((((char *) specialObjectsOop)) + BaseHeaderSize) + (TheDisplay << 2));
}
...
int fetchClassOf(int oop) {
	...
	if (ccIndex == 0) {
		...
		return longAt(((((char *) (longAt(((((char *) specialObjectsOop)) + BaseHeaderSize) + (CompactClasses << 2))))) + BaseHeaderSize) + ((ccIndex - 1) << 2));
	}
}
...
int findClassOfMethodforReceiver(int meth, int rcvr) {
	...
	/* begin fetchClassOf: */
	if ((rcvr & 1)) {
		currClass = longAt(((((char *) specialObjectsOop)) + BaseHeaderSize) + (ClassInteger << 2));
		goto l2;
	}
	...
	if (ccIndex == 0) {
		...
		currClass = longAt(((((char *) (longAt(((((char *) specialObjectsOop)) + BaseHeaderSize) + (CompactClasses << 2))))) + BaseHeaderSize) + ((ccIndex - 1) << 2));
		goto l2;
	}
l2:	/* end fetchClassOf: */;
	done = 0;
	...
	if (ccIndex1 == 0) {
		...
		return longAt(((((char *) (longAt(((((char *) specialObjectsOop)) + BaseHeaderSize) + (CompactClasses << 2))))) + BaseHeaderSize) + ((ccIndex1 - 1) << 2));
	}
	return null;
}
...
int findNewMethodInClass(int class) {
	...
	if (((methodCache[probe + MethodCacheSelector]) == messageSelector) && ((methodCache[probe + MethodCacheClass]) == class)) {
		...
		primitiveFunctionPointer = methodCache[probe + MethodCachePrimFunction];
		ok = 1;
		goto l1;
	}
...
l1:	/* end lengthOf:baseHeader:format: */;
	...
	/* begin fetchClassOf: */
	if ((oop & 1)) {
		class = longAt(((((char *) specialObjectsOop)) + BaseHeaderSize) + (ClassInteger << 2));
		goto l3;
	}
	ccIndex = (((unsigned) (longAt(oop))) >> 12) & 31;
	if (ccIndex == 0) {
		...
		class = longAt(((((char *) (longAt(((((char *) specialObjectsOop)) + BaseHeaderSize) + (CompactClasses << 2))))) + BaseHeaderSize) + ((ccIndex - 1) << 2));
		goto l3;
	}
l3:	/* end fetchClassOf: */;
...
int floatObjectOf(double aFloat) {
	...
	newFloatObj = instantiateSmallClasssizeInBytesfill(longAt(((((char *) specialObjectsOop)) + BaseHeaderSize) + (ClassFloat << 2)), 12, 0);
...
double floatValueOf(int oop) {
	...
	/* begin success: */
	successFlag = (cl == (longAt(((((char *) specialObjectsOop)) + BaseHeaderSize) + (ClassFloat << 2)))) && successFlag;
l1:	/* end assertClassOf:is: */;
	if (successFlag) {
		;
...
int fullGC(void) {
	...
	if (compilerInitialized) {
		...
		longAtput(((((char *) activeContext)) + BaseHeaderSize) + (InstructionPointerIndex << 2), ((((instructionPointer - method) - (BaseHeaderSize - 2)) << 1) | 1));
		longAtput(((((char *) activeContext)) + BaseHeaderSize) + (StackPointerIndex << 2), (((((((unsigned) ((stackPointer - activeContext) - BaseHeaderSize)) >> 2) - TempFrameStart) + 1) << 1) | 1));
	}
...
l1:	/* end fullCompaction */;
	...
	if (((longAt(freeBlock)) & AllButTypeMask) > shrinkThreshold) {
		/* begin shrinkObjectMemory: */
		delta1 = ((longAt(freeBlock)) & AllButTypeMask) - growHeadroom;
...
int fwdTableInit(int blkSize) {
	...
	fwdTableNext = ((endOfMemory + BaseHeaderSize) + 7) & 4294967288U;
...
int imageSegmentVersion(void) {
	...
	wholeWord = longAt((longAt(((((char *) specialObjectsOop)) + BaseHeaderSize) + (SelectorDoesNotUnderstand << 2))) + BaseHeaderSize);
...
int incrementalGC(void) {
	...
	/* begin forceInterruptCheck */
	interruptCheckCounter = -1000;
	if ((survivorCount > tenuringThreshold) || (rootTableCount >= RootTableRedZone)) {
		statTenures += 1;
		/* begin clearRootsTable */
		for (i = 1; i <= rootTableCount; i += 1) {
			oop = rootTable[i];
...
int initializeMemoryFirstFree(int firstFree) {
	...
	if (!((memoryLimit - fwdBlockBytes) >= (firstFree + BaseHeaderSize))) {
...
int initializeObjectMemory(int bytesToShift) {
	...
	nilObj = longAt(((((char *) specialObjectsOop)) + BaseHeaderSize) + (NilObject << 2));
	falseObj = longAt(((((char *) specialObjectsOop)) + BaseHeaderSize) + (FalseObject << 2));
	trueObj = longAt(((((char *) specialObjectsOop)) + BaseHeaderSize) + (TrueObject << 2));
	rootTableCount = 0;
...
int instantiateClassindexableSize(int classPointer, int size) {
	...
	/* begin sufficientSpaceToAllocate: */
	minFree = (lowSpaceThreshold + (byteSize + ((hdrSize - 1) * 4))) + BaseHeaderSize;
	if ((((unsigned ) ((longAt(freeBlock)) & AllButTypeMask))) >= (((unsigned ) minFree))) {
		enoughSpace = 1;
		goto l1;
	} else {
...
l1:	/* end sufficientSpaceToAllocate: */;
	...
	if ((((unsigned ) ((longAt(freeBlock)) & AllButTypeMask))) < (((unsigned ) ((byteSize + ((hdrSize - 1) * 4)) + BaseHeaderSize)))) {
		error("out of memory");
	}
	newFreeSize = ((longAt(freeBlock)) & AllButTypeMask) - (byteSize + ((hdrSize - 1) * 4));
	newChunk = freeBlock;
...
int instantiateContextsizeInBytes(int classPointer, int sizeInBytes) {
	...
	/* begin sufficientSpaceToAllocate: */
	minFree = (lowSpaceThreshold + (sizeInBytes + ((hdrSize - 1) * 4))) + BaseHeaderSize;
	if ((((unsigned ) ((longAt(freeBlock)) & AllButTypeMask))) >= (((unsigned ) minFree))) {
		enoughSpace = 1;
		goto l1;
	} else {
...
l1:	/* end sufficientSpaceToAllocate: */;
	...
	if ((((unsigned ) ((longAt(freeBlock)) & AllButTypeMask))) < (((unsigned ) ((sizeInBytes + ((hdrSize - 1) * 4)) + BaseHeaderSize)))) {
		error("out of memory");
	}
	newFreeSize = ((longAt(freeBlock)) & AllButTypeMask) - (sizeInBytes + ((hdrSize - 1) * 4));
	newChunk = freeBlock;
	...
	while (1) {
		...
		case 0:
			/* pushReceiverVariableBytecode */
			{
				...
				/* begin internalPush: */
				longAtput(localSP += 4, longAt(((((char *) receiver)) + BaseHeaderSize) + ((0 & 15) << 2)));
			}
;
			break;
		case 1:
			/* pushReceiverVariableBytecode */
			{
				...
				/* begin pushReceiverVariable: */
				/* begin internalPush: */
				longAtput(localSP += 4, longAt(((((char *) receiver)) + BaseHeaderSize) + ((1 & 15) << 2)));
			}
;
			break;
		case 2:
			/* pushReceiverVariableBytecode */
			{
				...
				/* begin pushReceiverVariable: */
				/* begin internalPush: */
				longAtput(localSP += 4, longAt(((((char *) receiver)) + BaseHeaderSize) + ((2 & 15) << 2)));
			}
;
			break;
		case 3:
			/* pushReceiverVariableBytecode */
			{
				...
				/* begin pushReceiverVariable: */
				/* begin internalPush: */
				longAtput(localSP += 4, longAt(((((char *) receiver)) + BaseHeaderSize) + ((3 & 15) << 2)));
			}
;
			break;
		case 4:
			/* pushReceiverVariableBytecode */
			{
				...
				/* begin pushReceiverVariable: */
				/* begin internalPush: */
				longAtput(localSP += 4, longAt(((((char *) receiver)) + BaseHeaderSize) + ((4 & 15) << 2)));
			}
;
			break;
		case 5:
			/* pushReceiverVariableBytecode */
			{
				...
				/* begin pushReceiverVariable: */
				/* begin internalPush: */
				longAtput(localSP += 4, longAt(((((char *) receiver)) + BaseHeaderSize) + ((5 & 15) << 2)));
			}
;
			break;
		case 6:
			/* pushReceiverVariableBytecode */
			{
				...
				/* begin pushReceiverVariable: */
				/* begin internalPush: */
				longAtput(localSP += 4, longAt(((((char *) receiver)) + BaseHeaderSize) + ((6 & 15) << 2)));
			}
;
			break;
		case 7:
			/* pushReceiverVariableBytecode */
			{
				...
				/* begin pushReceiverVariable: */
				/* begin internalPush: */
				longAtput(localSP += 4, longAt(((((char *) receiver)) + BaseHeaderSize) + ((7 & 15) << 2)));
			}
;
			break;
		case 8:
			/* pushReceiverVariableBytecode */
			{
				...
				/* begin pushReceiverVariable: */
				/* begin internalPush: */
				longAtput(localSP += 4, longAt(((((char *) receiver)) + BaseHeaderSize) + ((8 & 15) << 2)));
			}
;
			break;
		case 9:
			/* pushReceiverVariableBytecode */
			{
				...
				/* begin pushReceiverVariable: */
				/* begin internalPush: */
				longAtput(localSP += 4, longAt(((((char *) receiver)) + BaseHeaderSize) + ((9 & 15) << 2)));
			}
;
			break;
		case 10:
			/* pushReceiverVariableBytecode */
			{
				...
				/* begin pushReceiverVariable: */
				/* begin internalPush: */
				longAtput(localSP += 4, longAt(((((char *) receiver)) + BaseHeaderSize) + ((10 & 15) << 2)));
			}
;
			break;
		case 11:
			/* pushReceiverVariableBytecode */
			{
				...
				/* begin pushReceiverVariable: */
				/* begin internalPush: */
				longAtput(localSP += 4, longAt(((((char *) receiver)) + BaseHeaderSize) + ((11 & 15) << 2)));
			}
;
			break;
		case 12:
			/* pushReceiverVariableBytecode */
			{
				...
				/* begin pushReceiverVariable: */
				/* begin internalPush: */
				longAtput(localSP += 4, longAt(((((char *) receiver)) + BaseHeaderSize) + ((12 & 15) << 2)));
			}
;
			break;
		case 13:
			/* pushReceiverVariableBytecode */
			{
				...
				/* begin pushReceiverVariable: */
				/* begin internalPush: */
				longAtput(localSP += 4, longAt(((((char *) receiver)) + BaseHeaderSize) + ((13 & 15) << 2)));
			}
;
			break;
		case 14:
			/* pushReceiverVariableBytecode */
			{
				...
				/* begin pushReceiverVariable: */
				/* begin internalPush: */
				longAtput(localSP += 4, longAt(((((char *) receiver)) + BaseHeaderSize) + ((14 & 15) << 2)));
			}
;
			break;
		case 15:
			/* pushReceiverVariableBytecode */
			{
				...
				/* begin pushReceiverVariable: */
				/* begin internalPush: */
				longAtput(localSP += 4, longAt(((((char *) receiver)) + BaseHeaderSize) + ((15 & 15) << 2)));
			}
;
			break;
		case 16:
...
;
		...
		case 32:
			/* pushLiteralConstantBytecode */
			{
				...
				/* begin internalPush: */
				longAtput(localSP += 4, longAt(((((char *) method)) + BaseHeaderSize) + (((32 & 31) + LiteralStart) << 2)));
			}
;
			break;
		case 33:
			/* pushLiteralConstantBytecode */
			{
				...
				/* begin pushLiteralConstant: */
				/* begin internalPush: */
				longAtput(localSP += 4, longAt(((((char *) method)) + BaseHeaderSize) + (((33 & 31) + LiteralStart) << 2)));
			}
;
			break;
		case 34:
			/* pushLiteralConstantBytecode */
			{
				...
				/* begin pushLiteralConstant: */
				/* begin internalPush: */
				longAtput(localSP += 4, longAt(((((char *) method)) + BaseHeaderSize) + (((34 & 31) + LiteralStart) << 2)));
			}
;
			break;
		case 35:
			/* pushLiteralConstantBytecode */
			{
				...
				/* begin pushLiteralConstant: */
				/* begin internalPush: */
				longAtput(localSP += 4, longAt(((((char *) method)) + BaseHeaderSize) + (((35 & 31) + LiteralStart) << 2)));
			}
;
			break;
		case 36:
			/* pushLiteralConstantBytecode */
			{
				...
				/* begin pushLiteralConstant: */
				/* begin internalPush: */
				longAtput(localSP += 4, longAt(((((char *) method)) + BaseHeaderSize) + (((36 & 31) + LiteralStart) << 2)));
			}
;
			break;
		case 37:
			/* pushLiteralConstantBytecode */
			{
				...
				/* begin pushLiteralConstant: */
				/* begin internalPush: */
				longAtput(localSP += 4, longAt(((((char *) method)) + BaseHeaderSize) + (((37 & 31) + LiteralStart) << 2)));
			}
;
			break;
		case 38:
			/* pushLiteralConstantBytecode */
			{
				...
				/* begin pushLiteralConstant: */
				/* begin internalPush: */
				longAtput(localSP += 4, longAt(((((char *) method)) + BaseHeaderSize) + (((38 & 31) + LiteralStart) << 2)));
			}
;
			break;
		case 39:
			/* pushLiteralConstantBytecode */
			{
				...
				/* begin pushLiteralConstant: */
				/* begin internalPush: */
				longAtput(localSP += 4, longAt(((((char *) method)) + BaseHeaderSize) + (((39 & 31) + LiteralStart) << 2)));
			}
;
			break;
		case 40:
			/* pushLiteralConstantBytecode */
			{
				...
				/* begin pushLiteralConstant: */
				/* begin internalPush: */
				longAtput(localSP += 4, longAt(((((char *) method)) + BaseHeaderSize) + (((40 & 31) + LiteralStart) << 2)));
			}
;
			break;
		case 41:
			/* pushLiteralConstantBytecode */
			{
				...
				/* begin pushLiteralConstant: */
				/* begin internalPush: */
				longAtput(localSP += 4, longAt(((((char *) method)) + BaseHeaderSize) + (((41 & 31) + LiteralStart) << 2)));
			}
;
			break;
		case 42:
			/* pushLiteralConstantBytecode */
			{
				...
				/* begin pushLiteralConstant: */
				/* begin internalPush: */
				longAtput(localSP += 4, longAt(((((char *) method)) + BaseHeaderSize) + (((42 & 31) + LiteralStart) << 2)));
			}
;
			break;
		case 43:
			/* pushLiteralConstantBytecode */
			{
				...
				/* begin pushLiteralConstant: */
				/* begin internalPush: */
				longAtput(localSP += 4, longAt(((((char *) method)) + BaseHeaderSize) + (((43 & 31) + LiteralStart) << 2)));
			}
;
			break;
		case 44:
			/* pushLiteralConstantBytecode */
			{
				...
				/* begin pushLiteralConstant: */
				/* begin internalPush: */
				longAtput(localSP += 4, longAt(((((char *) method)) + BaseHeaderSize) + (((44 & 31) + LiteralStart) << 2)));
			}
;
			break;
		case 45:
			/* pushLiteralConstantBytecode */
			{
				...
				/* begin pushLiteralConstant: */
				/* begin internalPush: */
				longAtput(localSP += 4, longAt(((((char *) method)) + BaseHeaderSize) + (((45 & 31) + LiteralStart) << 2)));
			}
;
			break;
		case 46:
			/* pushLiteralConstantBytecode */
			{
				...
				/* begin pushLiteralConstant: */
				/* begin internalPush: */
				longAtput(localSP += 4, longAt(((((char *) method)) + BaseHeaderSize) + (((46 & 31) + LiteralStart) << 2)));
			}
;
			break;
		case 47:
			/* pushLiteralConstantBytecode */
			{
				...
				/* begin pushLiteralConstant: */
				/* begin internalPush: */
				longAtput(localSP += 4, longAt(((((char *) method)) + BaseHeaderSize) + (((47 & 31) + LiteralStart) << 2)));
			}
;
			break;
		case 48:
			/* pushLiteralConstantBytecode */
			{
				...
				/* begin pushLiteralConstant: */
				/* begin internalPush: */
				longAtput(localSP += 4, longAt(((((char *) method)) + BaseHeaderSize) + (((48 & 31) + LiteralStart) << 2)));
			}
;
			break;
		case 49:
			/* pushLiteralConstantBytecode */
			{
				...
				/* begin pushLiteralConstant: */
				/* begin internalPush: */
				longAtput(localSP += 4, longAt(((((char *) method)) + BaseHeaderSize) + (((49 & 31) + LiteralStart) << 2)));
			}
;
			break;
		case 50:
			/* pushLiteralConstantBytecode */
			{
				...
				/* begin pushLiteralConstant: */
				/* begin internalPush: */
				longAtput(localSP += 4, longAt(((((char *) method)) + BaseHeaderSize) + (((50 & 31) + LiteralStart) << 2)));
			}
;
			break;
		case 51:
			/* pushLiteralConstantBytecode */
			{
				...
				/* begin pushLiteralConstant: */
				/* begin internalPush: */
				longAtput(localSP += 4, longAt(((((char *) method)) + BaseHeaderSize) + (((51 & 31) + LiteralStart) << 2)));
			}
;
			break;
		case 52:
			/* pushLiteralConstantBytecode */
			{
				...
				/* begin pushLiteralConstant: */
				/* begin internalPush: */
				longAtput(localSP += 4, longAt(((((char *) method)) + BaseHeaderSize) + (((52 & 31) + LiteralStart) << 2)));
			}
;
			break;
		case 53:
			/* pushLiteralConstantBytecode */
			{
				...
				/* begin pushLiteralConstant: */
				/* begin internalPush: */
				longAtput(localSP += 4, longAt(((((char *) method)) + BaseHeaderSize) + (((53 & 31) + LiteralStart) << 2)));
			}
;
			break;
		case 54:
			/* pushLiteralConstantBytecode */
			{
				...
				/* begin pushLiteralConstant: */
				/* begin internalPush: */
				longAtput(localSP += 4, longAt(((((char *) method)) + BaseHeaderSize) + (((54 & 31) + LiteralStart) << 2)));
			}
;
			break;
		case 55:
			/* pushLiteralConstantBytecode */
			{
				...
				/* begin pushLiteralConstant: */
				/* begin internalPush: */
				longAtput(localSP += 4, longAt(((((char *) method)) + BaseHeaderSize) + (((55 & 31) + LiteralStart) << 2)));
			}
;
			break;
		case 56:
			/* pushLiteralConstantBytecode */
			{
				...
				/* begin pushLiteralConstant: */
				/* begin internalPush: */
				longAtput(localSP += 4, longAt(((((char *) method)) + BaseHeaderSize) + (((56 & 31) + LiteralStart) << 2)));
			}
;
			break;
		case 57:
			/* pushLiteralConstantBytecode */
			{
				...
				/* begin pushLiteralConstant: */
				/* begin internalPush: */
				longAtput(localSP += 4, longAt(((((char *) method)) + BaseHeaderSize) + (((57 & 31) + LiteralStart) << 2)));
			}
;
			break;
		case 58:
			/* pushLiteralConstantBytecode */
			{
				...
				/* begin pushLiteralConstant: */
				/* begin internalPush: */
				longAtput(localSP += 4, longAt(((((char *) method)) + BaseHeaderSize) + (((58 & 31) + LiteralStart) << 2)));
			}
;
			break;
		case 59:
			/* pushLiteralConstantBytecode */
			{
				...
				/* begin pushLiteralConstant: */
				/* begin internalPush: */
				longAtput(localSP += 4, longAt(((((char *) method)) + BaseHeaderSize) + (((59 & 31) + LiteralStart) << 2)));
			}
;
			break;
		case 60:
			/* pushLiteralConstantBytecode */
			{
				...
				/* begin pushLiteralConstant: */
				/* begin internalPush: */
				longAtput(localSP += 4, longAt(((((char *) method)) + BaseHeaderSize) + (((60 & 31) + LiteralStart) << 2)));
			}
;
			break;
		case 61:
			/* pushLiteralConstantBytecode */
			{
				...
				/* begin pushLiteralConstant: */
				/* begin internalPush: */
				longAtput(localSP += 4, longAt(((((char *) method)) + BaseHeaderSize) + (((61 & 31) + LiteralStart) << 2)));
			}
;
			break;
		case 62:
			/* pushLiteralConstantBytecode */
			{
				...
				/* begin pushLiteralConstant: */
				/* begin internalPush: */
				longAtput(localSP += 4, longAt(((((char *) method)) + BaseHeaderSize) + (((62 & 31) + LiteralStart) << 2)));
			}
;
			break;
		case 63:
			/* pushLiteralConstantBytecode */
			{
				...
				/* begin pushLiteralConstant: */
				/* begin internalPush: */
				longAtput(localSP += 4, longAt(((((char *) method)) + BaseHeaderSize) + (((63 & 31) + LiteralStart) << 2)));
			}
;
			break;
		case 64:
			/* pushLiteralVariableBytecode */
			{
				...
				/* begin internalPush: */
				longAtput(localSP += 4, longAt(((((char *) (longAt(((((char *) method)) + BaseHeaderSize) + (((64 & 31) + LiteralStart) << 2))))) + BaseHeaderSize) + (ValueIndex << 2)));
			}
;
			break;
		case 65:
			/* pushLiteralVariableBytecode */
			{
				...
				/* begin pushLiteralVariable: */
				/* begin internalPush: */
				longAtput(localSP += 4, longAt(((((char *) (longAt(((((char *) method)) + BaseHeaderSize) + (((65 & 31) + LiteralStart) << 2))))) + BaseHeaderSize) + (ValueIndex << 2)));
			}
;
			break;
		case 66:
			/* pushLiteralVariableBytecode */
			{
				...
				/* begin pushLiteralVariable: */
				/* begin internalPush: */
				longAtput(localSP += 4, longAt(((((char *) (longAt(((((char *) method)) + BaseHeaderSize) + (((66 & 31) + LiteralStart) << 2))))) + BaseHeaderSize) + (ValueIndex << 2)));
			}
;
			break;
		case 67:
			/* pushLiteralVariableBytecode */
			{
				...
				/* begin pushLiteralVariable: */
				/* begin internalPush: */
				longAtput(localSP += 4, longAt(((((char *) (longAt(((((char *) method)) + BaseHeaderSize) + (((67 & 31) + LiteralStart) << 2))))) + BaseHeaderSize) + (ValueIndex << 2)));
			}
;
			break;
		case 68:
			/* pushLiteralVariableBytecode */
			{
				...
				/* begin pushLiteralVariable: */
				/* begin internalPush: */
				longAtput(localSP += 4, longAt(((((char *) (longAt(((((char *) method)) + BaseHeaderSize) + (((68 & 31) + LiteralStart) << 2))))) + BaseHeaderSize) + (ValueIndex << 2)));
			}
;
			break;
		case 69:
			/* pushLiteralVariableBytecode */
			{
				...
				/* begin pushLiteralVariable: */
				/* begin internalPush: */
				longAtput(localSP += 4, longAt(((((char *) (longAt(((((char *) method)) + BaseHeaderSize) + (((69 & 31) + LiteralStart) << 2))))) + BaseHeaderSize) + (ValueIndex << 2)));
			}
;
			break;
		case 70:
			/* pushLiteralVariableBytecode */
			{
				...
				/* begin pushLiteralVariable: */
				/* begin internalPush: */
				longAtput(localSP += 4, longAt(((((char *) (longAt(((((char *) method)) + BaseHeaderSize) + (((70 & 31) + LiteralStart) << 2))))) + BaseHeaderSize) + (ValueIndex << 2)));
			}
;
			break;
		case 71:
			/* pushLiteralVariableBytecode */
			{
				...
				/* begin pushLiteralVariable: */
				/* begin internalPush: */
				longAtput(localSP += 4, longAt(((((char *) (longAt(((((char *) method)) + BaseHeaderSize) + (((71 & 31) + LiteralStart) << 2))))) + BaseHeaderSize) + (ValueIndex << 2)));
			}
;
			break;
		case 72:
			/* pushLiteralVariableBytecode */
			{
				...
				/* begin pushLiteralVariable: */
				/* begin internalPush: */
				longAtput(localSP += 4, longAt(((((char *) (longAt(((((char *) method)) + BaseHeaderSize) + (((72 & 31) + LiteralStart) << 2))))) + BaseHeaderSize) + (ValueIndex << 2)));
			}
;
			break;
		case 73:
			/* pushLiteralVariableBytecode */
			{
				...
				/* begin pushLiteralVariable: */
				/* begin internalPush: */
				longAtput(localSP += 4, longAt(((((char *) (longAt(((((char *) method)) + BaseHeaderSize) + (((73 & 31) + LiteralStart) << 2))))) + BaseHeaderSize) + (ValueIndex << 2)));
			}
;
			break;
		case 74:
			/* pushLiteralVariableBytecode */
			{
				...
				/* begin pushLiteralVariable: */
				/* begin internalPush: */
				longAtput(localSP += 4, longAt(((((char *) (longAt(((((char *) method)) + BaseHeaderSize) + (((74 & 31) + LiteralStart) << 2))))) + BaseHeaderSize) + (ValueIndex << 2)));
			}
;
			break;
		case 75:
			/* pushLiteralVariableBytecode */
			{
				...
				/* begin pushLiteralVariable: */
				/* begin internalPush: */
				longAtput(localSP += 4, longAt(((((char *) (longAt(((((char *) method)) + BaseHeaderSize) + (((75 & 31) + LiteralStart) << 2))))) + BaseHeaderSize) + (ValueIndex << 2)));
			}
;
			break;
		case 76:
			/* pushLiteralVariableBytecode */
			{
				...
				/* begin pushLiteralVariable: */
				/* begin internalPush: */
				longAtput(localSP += 4, longAt(((((char *) (longAt(((((char *) method)) + BaseHeaderSize) + (((76 & 31) + LiteralStart) << 2))))) + BaseHeaderSize) + (ValueIndex << 2)));
			}
;
			break;
		case 77:
			/* pushLiteralVariableBytecode */
			{
				...
				/* begin pushLiteralVariable: */
				/* begin internalPush: */
				longAtput(localSP += 4, longAt(((((char *) (longAt(((((char *) method)) + BaseHeaderSize) + (((77 & 31) + LiteralStart) << 2))))) + BaseHeaderSize) + (ValueIndex << 2)));
			}
;
			break;
		case 78:
			/* pushLiteralVariableBytecode */
			{
				...
				/* begin pushLiteralVariable: */
				/* begin internalPush: */
				longAtput(localSP += 4, longAt(((((char *) (longAt(((((char *) method)) + BaseHeaderSize) + (((78 & 31) + LiteralStart) << 2))))) + BaseHeaderSize) + (ValueIndex << 2)));
			}
;
			break;
		case 79:
			/* pushLiteralVariableBytecode */
			{
				...
				/* begin pushLiteralVariable: */
				/* begin internalPush: */
				longAtput(localSP += 4, longAt(((((char *) (longAt(((((char *) method)) + BaseHeaderSize) + (((79 & 31) + LiteralStart) << 2))))) + BaseHeaderSize) + (ValueIndex << 2)));
			}
;
			break;
		case 80:
			/* pushLiteralVariableBytecode */
			{
				...
				/* begin pushLiteralVariable: */
				/* begin internalPush: */
				longAtput(localSP += 4, longAt(((((char *) (longAt(((((char *) method)) + BaseHeaderSize) + (((80 & 31) + LiteralStart) << 2))))) + BaseHeaderSize) + (ValueIndex << 2)));
			}
;
			break;
		case 81:
			/* pushLiteralVariableBytecode */
			{
				...
				/* begin pushLiteralVariable: */
				/* begin internalPush: */
				longAtput(localSP += 4, longAt(((((char *) (longAt(((((char *) method)) + BaseHeaderSize) + (((81 & 31) + LiteralStart) << 2))))) + BaseHeaderSize) + (ValueIndex << 2)));
			}
;
			break;
		case 82:
			/* pushLiteralVariableBytecode */
			{
				...
				/* begin pushLiteralVariable: */
				/* begin internalPush: */
				longAtput(localSP += 4, longAt(((((char *) (longAt(((((char *) method)) + BaseHeaderSize) + (((82 & 31) + LiteralStart) << 2))))) + BaseHeaderSize) + (ValueIndex << 2)));
			}
;
			break;
		case 83:
			/* pushLiteralVariableBytecode */
			{
				...
				/* begin pushLiteralVariable: */
				/* begin internalPush: */
				longAtput(localSP += 4, longAt(((((char *) (longAt(((((char *) method)) + BaseHeaderSize) + (((83 & 31) + LiteralStart) << 2))))) + BaseHeaderSize) + (ValueIndex << 2)));
			}
;
			break;
		case 84:
			/* pushLiteralVariableBytecode */
			{
				...
				/* begin pushLiteralVariable: */
				/* begin internalPush: */
				longAtput(localSP += 4, longAt(((((char *) (longAt(((((char *) method)) + BaseHeaderSize) + (((84 & 31) + LiteralStart) << 2))))) + BaseHeaderSize) + (ValueIndex << 2)));
			}
;
			break;
		case 85:
			/* pushLiteralVariableBytecode */
			{
				...
				/* begin pushLiteralVariable: */
				/* begin internalPush: */
				longAtput(localSP += 4, longAt(((((char *) (longAt(((((char *) method)) + BaseHeaderSize) + (((85 & 31) + LiteralStart) << 2))))) + BaseHeaderSize) + (ValueIndex << 2)));
			}
;
			break;
		case 86:
			/* pushLiteralVariableBytecode */
			{
				...
				/* begin pushLiteralVariable: */
				/* begin internalPush: */
				longAtput(localSP += 4, longAt(((((char *) (longAt(((((char *) method)) + BaseHeaderSize) + (((86 & 31) + LiteralStart) << 2))))) + BaseHeaderSize) + (ValueIndex << 2)));
			}
;
			break;
		case 87:
			/* pushLiteralVariableBytecode */
			{
				...
				/* begin pushLiteralVariable: */
				/* begin internalPush: */
				longAtput(localSP += 4, longAt(((((char *) (longAt(((((char *) method)) + BaseHeaderSize) + (((87 & 31) + LiteralStart) << 2))))) + BaseHeaderSize) + (ValueIndex << 2)));
			}
;
			break;
		case 88:
			/* pushLiteralVariableBytecode */
			{
				...
				/* begin pushLiteralVariable: */
				/* begin internalPush: */
				longAtput(localSP += 4, longAt(((((char *) (longAt(((((char *) method)) + BaseHeaderSize) + (((88 & 31) + LiteralStart) << 2))))) + BaseHeaderSize) + (ValueIndex << 2)));
			}
;
			break;
		case 89:
			/* pushLiteralVariableBytecode */
			{
				...
				/* begin pushLiteralVariable: */
				/* begin internalPush: */
				longAtput(localSP += 4, longAt(((((char *) (longAt(((((char *) method)) + BaseHeaderSize) + (((89 & 31) + LiteralStart) << 2))))) + BaseHeaderSize) + (ValueIndex << 2)));
			}
;
			break;
		case 90:
			/* pushLiteralVariableBytecode */
			{
				...
				/* begin pushLiteralVariable: */
				/* begin internalPush: */
				longAtput(localSP += 4, longAt(((((char *) (longAt(((((char *) method)) + BaseHeaderSize) + (((90 & 31) + LiteralStart) << 2))))) + BaseHeaderSize) + (ValueIndex << 2)));
			}
;
			break;
		case 91:
			/* pushLiteralVariableBytecode */
			{
				...
				/* begin pushLiteralVariable: */
				/* begin internalPush: */
				longAtput(localSP += 4, longAt(((((char *) (longAt(((((char *) method)) + BaseHeaderSize) + (((91 & 31) + LiteralStart) << 2))))) + BaseHeaderSize) + (ValueIndex << 2)));
			}
;
			break;
		case 92:
			/* pushLiteralVariableBytecode */
			{
				...
				/* begin pushLiteralVariable: */
				/* begin internalPush: */
				longAtput(localSP += 4, longAt(((((char *) (longAt(((((char *) method)) + BaseHeaderSize) + (((92 & 31) + LiteralStart) << 2))))) + BaseHeaderSize) + (ValueIndex << 2)));
			}
;
			break;
		case 93:
			/* pushLiteralVariableBytecode */
			{
				...
				/* begin pushLiteralVariable: */
				/* begin internalPush: */
				longAtput(localSP += 4, longAt(((((char *) (longAt(((((char *) method)) + BaseHeaderSize) + (((93 & 31) + LiteralStart) << 2))))) + BaseHeaderSize) + (ValueIndex << 2)));
			}
;
			break;
		case 94:
			/* pushLiteralVariableBytecode */
			{
				...
				/* begin pushLiteralVariable: */
				/* begin internalPush: */
				longAtput(localSP += 4, longAt(((((char *) (longAt(((((char *) method)) + BaseHeaderSize) + (((94 & 31) + LiteralStart) << 2))))) + BaseHeaderSize) + (ValueIndex << 2)));
			}
;
			break;
		case 95:
			/* pushLiteralVariableBytecode */
			{
				...
				/* begin pushLiteralVariable: */
				/* begin internalPush: */
				longAtput(localSP += 4, longAt(((((char *) (longAt(((((char *) method)) + BaseHeaderSize) + (((95 & 31) + LiteralStart) << 2))))) + BaseHeaderSize) + (ValueIndex << 2)));
			}
;
			break;
		case 96:
		...
		commonReturn:
			/* commonReturn */
			{
				...
				if ((localCntx == nilOop) || ((longAt(((((char *) localCntx)) + BaseHeaderSize) + (InstructionPointerIndex << 2))) == nilOop)) {
					...
					messageSelector = longAt(((((char *) specialObjectsOop)) + BaseHeaderSize) + (SelectorCannotReturn << 2));
					argumentCount = 1;
					goto normalSend;
					goto l43;
				}
				thisCntx = longAt(((((char *) activeContext)) + BaseHeaderSize) + (SenderIndex << 2));
				...
				l44:	/* end isUnwindMarked: */;
					if (unwindMarked) {
						...
						messageSelector = longAt(((((char *) specialObjectsOop)) + BaseHeaderSize) + (SelectorAboutToReturn << 2));
						argumentCount = 2;
						goto normalSend;
						goto l43;
					}
						...
						if (thisCntx >= youngStart) {
							...
							if (((((unsigned) header1) >> 12) & 31) == 14) {
								if ((header1 & SizeMask) == SmallContextSize) {
									longAtput(((((char *) thisCntx)) + BaseHeaderSize) + (0 << 2), freeContexts);
									freeContexts = thisCntx;
								}
								if ((header1 & SizeMask) == LargeContextSize) {
									longAtput(((((char *) thisCntx)) + BaseHeaderSize) + (0 << 2), freeLargeContexts);
				...
				receiver = longAt(((((char *) tmp)) + BaseHeaderSize) + (ReceiverIndex << 2));
				method = longAt(((((char *) tmp)) + BaseHeaderSize) + (MethodIndex << 2));
				tmp = ((longAt(((((char *) thisCntx)) + BaseHeaderSize) + (InstructionPointerIndex << 2))) >> 1);
				localIP = ((char *) (((method + tmp) + BaseHeaderSize) - 2));
...
;
		...
		case 125:
			/* returnTopFromBlock */
			{
				localReturnContext = longAt(((((char *) activeContext)) + BaseHeaderSize) + (CallerIndex << 2));
				localReturnValue = longAt(localSP);
				goto commonReturn;
			}
;
		...
		case 128:
			/* extendedPushBytecode */
			{
				...
				if (variableType == 0) {
					/* begin pushReceiverVariable: */
					/* begin internalPush: */
					longAtput(localSP += 4, longAt(((((char *) receiver)) + BaseHeaderSize) + (variableIndex << 2)));
					goto l1;
				}
				if (variableType == 1) {
					/* begin pushTemporaryVariable: */
				...
				if (variableType == 2) {
					/* begin pushLiteralConstant: */
					/* begin internalPush: */
					longAtput(localSP += 4, longAt(((((char *) method)) + BaseHeaderSize) + ((variableIndex + LiteralStart) << 2)));
					goto l1;
				}
				if (variableType == 3) {
					/* begin pushLiteralVariable: */
					/* begin internalPush: */
					longAtput(localSP += 4, longAt(((((char *) (longAt(((((char *) method)) + BaseHeaderSize) + ((variableIndex + LiteralStart) << 2))))) + BaseHeaderSize) + (ValueIndex << 2)));
					goto l1;
				}
			}
;
		...
		case 129:
			/* extendedStoreBytecode */
			{
				...
				if (variableType == 3) {
					association = longAt(((((char *) method)) + BaseHeaderSize) + ((variableIndex + LiteralStart) << 2));
					/* begin storePointer:ofObject:withValue: */
					valuePointer1 = longAt(localSP);
					if (association < youngStart) {
...
;
		...
		case 131:
			/* singleExtendedSendBytecode */
			{
				int descriptor;
				descriptor = byteAt(++localIP);
				messageSelector = longAt(((((char *) method)) + BaseHeaderSize) + (((descriptor & 31) + LiteralStart) << 2));
...
;
		...
		normalSend:
			/* normalSend */
			{
				...
				int ccIndex;
				/* inline:  */;
				rcvr = longAt(localSP - (argumentCount * 4));
				/* begin fetchClassOf: */
				if ((rcvr & 1)) {
					lkupClass = longAt(((((char *) specialObjectsOop)) + BaseHeaderSize) + (ClassInteger << 2));
					goto l45;
				}
				ccIndex = (((unsigned) (longAt(rcvr))) >> 12) & 31;
				if (ccIndex == 0) {
					lkupClass = (longAt(rcvr - 4)) & AllButTypeMask;
					goto l45;
				} else {
					lkupClass = longAt(((((char *) (longAt(((((char *) specialObjectsOop)) + BaseHeaderSize) + (CompactClasses << 2))))) + BaseHeaderSize) + ((ccIndex - 1) << 2));
					goto l45;
				}
...
;
		...
		commonSend:
			...
			l46:	/* end lookupInMethodCacheSel:class: */;
				...
				methodHeader = longAt(((((char *) newMethod)) + BaseHeaderSize) + (HeaderIndex << 2));
				needsLarge = methodHeader & LargeContextBit;
				if ((needsLarge == 0) && (freeContexts != NilContext)) {
					newContext = freeContexts;
					freeContexts = longAt(((((char *) newContext)) + BaseHeaderSize) + (0 << 2));
				} else {
					/* begin externalizeIPandSP */
					instructionPointer = ((int) localIP);
					stackPointer = ((int) localSP);
				...
				longAtput(where + (SenderIndex << 2), activeContext);
				...
				longAtput(where + (MethodIndex << 2), newMethod);
				...
				longAtput(((((char *) activeContext)) + BaseHeaderSize) + (InstructionPointerIndex << 2), (((((((int) localIP )) + 2) - (method + BaseHeaderSize)) << 1) | 1));
				longAtput(((((char *) activeContext)) + BaseHeaderSize) + (StackPointerIndex << 2), (((((((unsigned) ((((int) localSP )) - (activeContext + BaseHeaderSize))) >> 2) - TempFrameStart) + 1) << 1) | 1));
...
;
		...
		case 132:
			/* doubleExtendedDoAnythingBytecode */
			{
				...
				if (opType == 0) {
					messageSelector = longAt(((((char *) method)) + BaseHeaderSize) + ((byte3 + LiteralStart) << 2));
				...
				if (opType == 2) {
					/* begin pushReceiverVariable: */
					/* begin internalPush: */
					longAtput(localSP += 4, longAt(((((char *) receiver)) + BaseHeaderSize) + (byte3 << 2)));
					goto l4;
				}
				if (opType == 3) {
					/* begin pushLiteralConstant: */
					/* begin internalPush: */
					longAtput(localSP += 4, longAt(((((char *) method)) + BaseHeaderSize) + ((byte3 + LiteralStart) << 2)));
					goto l4;
				}
				if (opType == 4) {
					/* begin pushLiteralVariable: */
					/* begin internalPush: */
					longAtput(localSP += 4, longAt(((((char *) (longAt(((((char *) method)) + BaseHeaderSize) + ((byte3 + LiteralStart) << 2))))) + BaseHeaderSize) + (ValueIndex << 2)));
					goto l4;
				}
				if (opType == 5) {
					top = longAt(localSP);
				...
				if (opType == 7) {
					top = longAt(localSP);
					/* begin storePointer:ofObject:withValue: */
					oop2 = longAt(((((char *) method)) + BaseHeaderSize) + ((byte3 + LiteralStart) << 2));
					if (oop2 < youngStart) {
...
;
		...
		commonSupersend:
			/* superclassSend */
			{
				...
				/* inline:  */;
				/* begin superclassOf: */
				classPointer = longAt(((((char *) (longAt(((((char *) method)) + BaseHeaderSize) + (((((((unsigned) (longAt(((((char *) method)) + BaseHeaderSize) + (HeaderIndex << 2)))) >> 10) & 255) - 1) + LiteralStart) << 2))))) + BaseHeaderSize) + (ValueIndex << 2));
				lkupClass = longAt(((((char *) classPointer)) + BaseHeaderSize) + (SuperclassIndex << 2));
				rcvr = longAt(localSP - (argumentCount * 4));
				/* begin fetchClassOf: */
				if ((rcvr & 1)) {
					receiverClass = longAt(((((char *) specialObjectsOop)) + BaseHeaderSize) + (ClassInteger << 2));
					goto l48;
				}
				ccIndex = (((unsigned) (longAt(rcvr))) >> 12) & 31;
				if (ccIndex == 0) {
					receiverClass = (longAt(rcvr - 4)) & AllButTypeMask;
					goto l48;
				} else {
					receiverClass = longAt(((((char *) (longAt(((((char *) specialObjectsOop)) + BaseHeaderSize) + (CompactClasses << 2))))) + BaseHeaderSize) + ((ccIndex - 1) << 2));
					goto l48;
				}
...
;
		...
		case 134:
			/* secondExtendedSendBytecode */
			{
				int descriptor;
				descriptor = byteAt(++localIP);
				messageSelector = longAt(((((char *) method)) + BaseHeaderSize) + (((descriptor & 63) + LiteralStart) << 2));
			...
			/* experimentalBytecode */
			{
				...
				if (byte2 < 32) {
					...
					if (byte2 > 64) {
						...
						arg2Val = longAt(((((char *) method)) + BaseHeaderSize) + (((byte2 & 31) + LiteralStart) << 2));
						if ((arg2Val & 1)) {
							arg2Val = (arg2Val >> 1);
						} else {
							/* begin fetchNextBytecode */
		...
		case 159:
			/* shortConditionalJump */
			{
				...
				if (boolean == falseObj) {
					...
					if (!(boolean == trueObj)) {
						messageSelector = longAt(((((char *) specialObjectsOop)) + BaseHeaderSize) + (SelectorMustBeBoolean << 2));
						argumentCount = 0;
						goto normalSend;
						goto l6;
					}
...
;
		...
		case 176:
			/* bytecodePrimAdd */
			{
				...
				messageSelector = longAt(((((char *) (longAt(((((char *) specialObjectsOop)) + BaseHeaderSize) + (SpecialSelectors << 2))))) + BaseHeaderSize) + ((0 * 2) << 2));
				argumentCount = 1;
				goto normalSend;
			}
;
		...
		case 177:
			/* bytecodePrimSubtract */
			{
				...
				messageSelector = longAt(((((char *) (longAt(((((char *) specialObjectsOop)) + BaseHeaderSize) + (SpecialSelectors << 2))))) + BaseHeaderSize) + ((1 * 2) << 2));
				argumentCount = 1;
				goto normalSend;
			}
;
		...
		case 178:
			/* bytecodePrimLessThan */
			{
				...
				messageSelector = longAt(((((char *) (longAt(((((char *) specialObjectsOop)) + BaseHeaderSize) + (SpecialSelectors << 2))))) + BaseHeaderSize) + ((2 * 2) << 2));
				argumentCount = 1;
				goto normalSend;
			}
;
		...
		case 179:
			/* bytecodePrimGreaterThan */
			{
				...
				messageSelector = longAt(((((char *) (longAt(((((char *) specialObjectsOop)) + BaseHeaderSize) + (SpecialSelectors << 2))))) + BaseHeaderSize) + ((3 * 2) << 2));
				argumentCount = 1;
				goto normalSend;
			}
;
		...
		case 180:
			/* bytecodePrimLessOrEqual */
			{
				...
				messageSelector = longAt(((((char *) (longAt(((((char *) specialObjectsOop)) + BaseHeaderSize) + (SpecialSelectors << 2))))) + BaseHeaderSize) + ((4 * 2) << 2));
				argumentCount = 1;
				goto normalSend;
			}
;
		...
		case 181:
			/* bytecodePrimGreaterOrEqual */
			{
				...
				messageSelector = longAt(((((char *) (longAt(((((char *) specialObjectsOop)) + BaseHeaderSize) + (SpecialSelectors << 2))))) + BaseHeaderSize) + ((5 * 2) << 2));
				argumentCount = 1;
				goto normalSend;
			}
;
		...
		case 182:
			/* bytecodePrimEqual */
			{
				...
				messageSelector = longAt(((((char *) (longAt(((((char *) specialObjectsOop)) + BaseHeaderSize) + (SpecialSelectors << 2))))) + BaseHeaderSize) + ((6 * 2) << 2));
				argumentCount = 1;
				goto normalSend;
			}
;
		...
		case 183:
			/* bytecodePrimNotEqual */
			{
				...
				messageSelector = longAt(((((char *) (longAt(((((char *) specialObjectsOop)) + BaseHeaderSize) + (SpecialSelectors << 2))))) + BaseHeaderSize) + ((7 * 2) << 2));
				argumentCount = 1;
				goto normalSend;
			}
;
		...
		case 184:
			/* bytecodePrimMultiply */
			{
				...
				messageSelector = longAt(((((char *) (longAt(((((char *) specialObjectsOop)) + BaseHeaderSize) + (SpecialSelectors << 2))))) + BaseHeaderSize) + ((8 * 2) << 2));
				argumentCount = 1;
				goto normalSend;
			}
;
		...
		case 185:
			/* bytecodePrimDivide */
			{
				...
				messageSelector = longAt(((((char *) (longAt(((((char *) specialObjectsOop)) + BaseHeaderSize) + (SpecialSelectors << 2))))) + BaseHeaderSize) + ((9 * 2) << 2));
				argumentCount = 1;
				goto normalSend;
			}
;
		...
		case 186:
			/* bytecodePrimMod */
			{
				...
				messageSelector = longAt(((((char *) (longAt(((((char *) specialObjectsOop)) + BaseHeaderSize) + (SpecialSelectors << 2))))) + BaseHeaderSize) + ((10 * 2) << 2));
				argumentCount = 1;
				goto normalSend;
			}
;
		...
		case 187:
			/* bytecodePrimMakePoint */
			{
				...
				if ((rcvr & 1)) {
					if ((argument & 1)) {
						...
						pointResult = instantiateSmallClasssizeInBytesfill(longAt(((((char *) specialObjectsOop)) + BaseHeaderSize) + (ClassPoint << 2)), 12, nilObj);
						/* begin storePointer:ofObject:withValue: */
						...
						/* begin makePointwithxValue:yValue: */
						pointResult1 = instantiateSmallClasssizeInBytesfill(longAt(((((char *) specialObjectsOop)) + BaseHeaderSize) + (ClassPoint << 2)), 12, nilObj);
						/* begin storePointer:ofObject:withValue: */
					...
					if (!((fetchClassOf(rcvr)) == (longAt(((((char *) specialObjectsOop)) + BaseHeaderSize) + (ClassFloat << 2))))) {
						/* begin success: */
						successFlag = 0 && successFlag;
						goto l21;
					}
					/* begin makePointwithxValue:yValue: */
					pointResult2 = instantiateSmallClasssizeInBytesfill(longAt(((((char *) specialObjectsOop)) + BaseHeaderSize) + (ClassPoint << 2)), 12, nilObj);
					/* begin storePointer:ofObject:withValue: */
				...
				/* begin pop:thenPush: */
				longAtput(sp = stackPointer - ((2 - 1) * 4), pt);
				stackPointer = sp;
			l21:	/* end primitiveMakePoint */;
				...
				messageSelector = longAt(((((char *) (longAt(((((char *) specialObjectsOop)) + BaseHeaderSize) + (SpecialSelectors << 2))))) + BaseHeaderSize) + ((11 * 2) << 2));
				argumentCount = 1;
				goto normalSend;
			}
;
		...
		case 188:
			...
			l23:	/* end checkedIntegerValueOf: */;
				...
				messageSelector = longAt(((((char *) (longAt(((((char *) specialObjectsOop)) + BaseHeaderSize) + (SpecialSelectors << 2))))) + BaseHeaderSize) + ((12 * 2) << 2));
				argumentCount = 1;
				goto normalSend;
			}
;
		...
		case 189:
			/* bytecodePrimDiv */
			{
				...
				messageSelector = longAt(((((char *) (longAt(((((char *) specialObjectsOop)) + BaseHeaderSize) + (SpecialSelectors << 2))))) + BaseHeaderSize) + ((13 * 2) << 2));
				argumentCount = 1;
				goto normalSend;
			}
;
		...
		case 190:
			/* bytecodePrimBitAnd */
			{
				...
				messageSelector = longAt(((((char *) (longAt(((((char *) specialObjectsOop)) + BaseHeaderSize) + (SpecialSelectors << 2))))) + BaseHeaderSize) + ((14 * 2) << 2));
				argumentCount = 1;
				goto normalSend;
			}
;
		...
		case 191:
			/* bytecodePrimBitOr */
			{
				...
				messageSelector = longAt(((((char *) (longAt(((((char *) specialObjectsOop)) + BaseHeaderSize) + (SpecialSelectors << 2))))) + BaseHeaderSize) + ((15 * 2) << 2));
				argumentCount = 1;
				goto normalSend;
			}
;
		...
		case 192:
			/* bytecodePrimAt */
			{
				...
				if (successFlag) {
					...
					if ((atCache[atIx + AtCacheOop]) == rcvr) {
						...
						if (((((unsigned ) ((index >> 1)))) >= 1) && ((((unsigned ) ((index >> 1)))) <= (((unsigned ) stSize)))) {
							...
							if (fmt >= 16) {
								result = longAt(((((char *) (longAt(((((char *) specialObjectsOop)) + BaseHeaderSize) + (CharacterTable << 2))))) + BaseHeaderSize) + ((byteAt(((((char *) rcvr)) + BaseHeaderSize) + (((index >> 1)) - 1))) << 2));
								goto l28;
							} else {
				...
				messageSelector = longAt(((((char *) (longAt(((((char *) specialObjectsOop)) + BaseHeaderSize) + (SpecialSelectors << 2))))) + BaseHeaderSize) + ((16 * 2) << 2));
				argumentCount = 1;
				goto normalSend;
			}
;
		...
		case 193:
			/* bytecodePrimAtPut */
			{
				...
				messageSelector = longAt(((((char *) (longAt(((((char *) specialObjectsOop)) + BaseHeaderSize) + (SpecialSelectors << 2))))) + BaseHeaderSize) + ((17 * 2) << 2));
				argumentCount = 2;
				goto normalSend;
			}
;
		...
		case 194:
			/* bytecodePrimSize */
			{
				messageSelector = longAt(((((char *) (longAt(((((char *) specialObjectsOop)) + BaseHeaderSize) + (SpecialSelectors << 2))))) + BaseHeaderSize) + ((18 * 2) << 2));
				argumentCount = 0;
				goto normalSend;
			}
;
		...
		case 195:
			/* bytecodePrimNext */
			{
				messageSelector = longAt(((((char *) (longAt(((((char *) specialObjectsOop)) + BaseHeaderSize) + (SpecialSelectors << 2))))) + BaseHeaderSize) + ((19 * 2) << 2));
				argumentCount = 0;
				goto normalSend;
			}
;
		...
		case 196:
			/* bytecodePrimNextPut */
			{
				messageSelector = longAt(((((char *) (longAt(((((char *) specialObjectsOop)) + BaseHeaderSize) + (SpecialSelectors << 2))))) + BaseHeaderSize) + ((20 * 2) << 2));
				argumentCount = 1;
				goto normalSend;
			}
;
		...
		case 197:
			/* bytecodePrimAtEnd */
			{
				messageSelector = longAt(((((char *) (longAt(((((char *) specialObjectsOop)) + BaseHeaderSize) + (SpecialSelectors << 2))))) + BaseHeaderSize) + ((21 * 2) << 2));
				argumentCount = 0;
				goto normalSend;
			}
;
...
;
		...
		case 199:
			/* bytecodePrimClass */
			{
				...
				/* begin fetchClassOf: */
				if ((rcvr & 1)) {
					oop = longAt(((((char *) specialObjectsOop)) + BaseHeaderSize) + (ClassInteger << 2));
					goto l32;
				}
				ccIndex = (((unsigned) (longAt(rcvr))) >> 12) & 31;
				if (ccIndex == 0) {
					...
					oop = longAt(((((char *) (longAt(((((char *) specialObjectsOop)) + BaseHeaderSize) + (CompactClasses << 2))))) + BaseHeaderSize) + ((ccIndex - 1) << 2));
					goto l32;
				}
		...
		case 200:
			/* bytecodePrimBlockCopy */
			{
				...
				l34:	/* end sizeBitsOf: */;
					...
					newContext = instantiateContextsizeInBytes(longAt(((((char *) specialObjectsOop)) + BaseHeaderSize) + (ClassBlockContext << 2)), contextSize);
					/* begin popRemappableOop */
					oop = remapBuffer[remapBufferCount];
					remapBufferCount -= 1;
					methodContext = oop;
					...
					longAtput(((((char *) newContext)) + BaseHeaderSize) + (BlockArgumentCountIndex << 2), longAt(stackPointer - (0 * 4)));
					longAtput(((((char *) newContext)) + BaseHeaderSize) + (HomeIndex << 2), methodContext);
					longAtput(((((char *) newContext)) + BaseHeaderSize) + (SenderIndex << 2), nilObj);
					/* begin pop:thenPush: */
				...
				if (!(successFlag)) {
					messageSelector = longAt(((((char *) (longAt(((((char *) specialObjectsOop)) + BaseHeaderSize) + (SpecialSelectors << 2))))) + BaseHeaderSize) + ((24 * 2) << 2));
					argumentCount = 1;
					goto normalSend;
					goto l33;
				}
...
;
		...
		case 201:
			/* bytecodePrimValue */
			{
				...
				/* begin success: */
				successFlag = (cl == (longAt(((((char *) specialObjectsOop)) + BaseHeaderSize) + (ClassBlockContext << 2)))) && successFlag;
			l36:	/* end assertClassOf:is: */;
				...
				if (!(successFlag)) {
					messageSelector = longAt(((((char *) (longAt(((((char *) specialObjectsOop)) + BaseHeaderSize) + (SpecialSelectors << 2))))) + BaseHeaderSize) + ((25 * 2) << 2));
					argumentCount = 0;
					goto normalSend;
					goto l35;
				}
...
;
		...
		case 202:
			...
			l38:	/* end assertClassOf:is: */;
				...
				if (!(successFlag)) {
					messageSelector = longAt(((((char *) (longAt(((((char *) specialObjectsOop)) + BaseHeaderSize) + (SpecialSelectors << 2))))) + BaseHeaderSize) + ((26 * 2) << 2));
					argumentCount = 1;
					goto normalSend;
					goto l37;
				}
...
;
		...
		case 203:
			/* bytecodePrimDo */
			{
				messageSelector = longAt(((((char *) (longAt(((((char *) specialObjectsOop)) + BaseHeaderSize) + (SpecialSelectors << 2))))) + BaseHeaderSize) + ((27 * 2) << 2));
				argumentCount = 1;
				goto normalSend;
			}
;
		...
		case 204:
			/* bytecodePrimNew */
			{
				messageSelector = longAt(((((char *) (longAt(((((char *) specialObjectsOop)) + BaseHeaderSize) + (SpecialSelectors << 2))))) + BaseHeaderSize) + ((28 * 2) << 2));
				argumentCount = 0;
				goto normalSend;
			}
;
		...
		case 205:
			...
			{
				messageSelector = longAt(((((char *) (longAt(((((char *) specialObjectsOop)) + BaseHeaderSize) + (SpecialSelectors << 2))))) + BaseHeaderSize) + ((29 * 2) << 2));
				argumentCount = 1;
				goto normalSend;
			}
;
		...
		case 206:
			/* bytecodePrimPointX */
			{
				...
				/* begin success: */
				successFlag = (cl == (longAt(((((char *) specialObjectsOop)) + BaseHeaderSize) + (ClassPoint << 2)))) && successFlag;
			l40:	/* end assertClassOf:is: */;
				...
				messageSelector = longAt(((((char *) (longAt(((((char *) specialObjectsOop)) + BaseHeaderSize) + (SpecialSelectors << 2))))) + BaseHeaderSize) + ((30 * 2) << 2));
				argumentCount = 0;
				goto normalSend;
			}
;
		...
		case 207:
			...
			l42:	/* end assertClassOf:is: */;
				...
				messageSelector = longAt(((((char *) (longAt(((((char *) specialObjectsOop)) + BaseHeaderSize) + (SpecialSelectors << 2))))) + BaseHeaderSize) + ((31 * 2) << 2));
				argumentCount = 0;
				goto normalSend;
			}
;
		...
		case 208:
			...
			{
				messageSelector = longAt(((((char *) method)) + BaseHeaderSize) + (((208 & 15) + LiteralStart) << 2));
...
;
		...
		case 209:
			/* sendLiteralSelectorBytecode */
			{
				messageSelector = longAt(((((char *) method)) + BaseHeaderSize) + (((209 & 15) + LiteralStart) << 2));
...
;
		...
		case 210:
			/* sendLiteralSelectorBytecode */
			{
				messageSelector = longAt(((((char *) method)) + BaseHeaderSize) + (((210 & 15) + LiteralStart) << 2));
...
;
		...
		case 211:
			/* sendLiteralSelectorBytecode */
			{
				messageSelector = longAt(((((char *) method)) + BaseHeaderSize) + (((211 & 15) + LiteralStart) << 2));
...
;
		...
		case 212:
			/* sendLiteralSelectorBytecode */
			{
				messageSelector = longAt(((((char *) method)) + BaseHeaderSize) + (((212 & 15) + LiteralStart) << 2));
...
;
		...
		case 213:
			/* sendLiteralSelectorBytecode */
			{
				messageSelector = longAt(((((char *) method)) + BaseHeaderSize) + (((213 & 15) + LiteralStart) << 2));
...
;
		...
		case 214:
			/* sendLiteralSelectorBytecode */
			{
				messageSelector = longAt(((((char *) method)) + BaseHeaderSize) + (((214 & 15) + LiteralStart) << 2));
...
;
		...
		case 215:
			/* sendLiteralSelectorBytecode */
			{
				messageSelector = longAt(((((char *) method)) + BaseHeaderSize) + (((215 & 15) + LiteralStart) << 2));
...
;
		...
		case 216:
			/* sendLiteralSelectorBytecode */
			{
				messageSelector = longAt(((((char *) method)) + BaseHeaderSize) + (((216 & 15) + LiteralStart) << 2));
...
;
		...
		case 217:
			/* sendLiteralSelectorBytecode */
			{
				messageSelector = longAt(((((char *) method)) + BaseHeaderSize) + (((217 & 15) + LiteralStart) << 2));
...
;
		...
		case 218:
			/* sendLiteralSelectorBytecode */
			{
				messageSelector = longAt(((((char *) method)) + BaseHeaderSize) + (((218 & 15) + LiteralStart) << 2));
...
;
		...
		case 219:
			/* sendLiteralSelectorBytecode */
			{
				messageSelector = longAt(((((char *) method)) + BaseHeaderSize) + (((219 & 15) + LiteralStart) << 2));
...
;
		...
		case 220:
			/* sendLiteralSelectorBytecode */
			{
				messageSelector = longAt(((((char *) method)) + BaseHeaderSize) + (((220 & 15) + LiteralStart) << 2));
...
;
		...
		case 221:
			/* sendLiteralSelectorBytecode */
			{
				messageSelector = longAt(((((char *) method)) + BaseHeaderSize) + (((221 & 15) + LiteralStart) << 2));
...
;
		...
		case 222:
			/* sendLiteralSelectorBytecode */
			{
				messageSelector = longAt(((((char *) method)) + BaseHeaderSize) + (((222 & 15) + LiteralStart) << 2));
...
;
		...
		case 223:
			/* sendLiteralSelectorBytecode */
			{
				messageSelector = longAt(((((char *) method)) + BaseHeaderSize) + (((223 & 15) + LiteralStart) << 2));
...
;
		...
		case 224:
			/* sendLiteralSelectorBytecode */
			{
				messageSelector = longAt(((((char *) method)) + BaseHeaderSize) + (((224 & 15) + LiteralStart) << 2));
...
;
		...
		case 225:
			/* sendLiteralSelectorBytecode */
			{
				messageSelector = longAt(((((char *) method)) + BaseHeaderSize) + (((225 & 15) + LiteralStart) << 2));
...
;
		...
		case 226:
			/* sendLiteralSelectorBytecode */
			{
				messageSelector = longAt(((((char *) method)) + BaseHeaderSize) + (((226 & 15) + LiteralStart) << 2));
...
;
		...
		case 227:
			/* sendLiteralSelectorBytecode */
			{
				messageSelector = longAt(((((char *) method)) + BaseHeaderSize) + (((227 & 15) + LiteralStart) << 2));
...
;
		...
		case 228:
			/* sendLiteralSelectorBytecode */
			{
				messageSelector = longAt(((((char *) method)) + BaseHeaderSize) + (((228 & 15) + LiteralStart) << 2));
...
;
		...
		case 229:
			/* sendLiteralSelectorBytecode */
			{
				messageSelector = longAt(((((char *) method)) + BaseHeaderSize) + (((229 & 15) + LiteralStart) << 2));
...
;
		...
		case 230:
			/* sendLiteralSelectorBytecode */
			{
				messageSelector = longAt(((((char *) method)) + BaseHeaderSize) + (((230 & 15) + LiteralStart) << 2));
...
;
		...
		case 231:
			/* sendLiteralSelectorBytecode */
			{
				messageSelector = longAt(((((char *) method)) + BaseHeaderSize) + (((231 & 15) + LiteralStart) << 2));
...
;
		...
		case 232:
			/* sendLiteralSelectorBytecode */
			{
				messageSelector = longAt(((((char *) method)) + BaseHeaderSize) + (((232 & 15) + LiteralStart) << 2));
...
;
		...
		case 233:
			/* sendLiteralSelectorBytecode */
			{
				messageSelector = longAt(((((char *) method)) + BaseHeaderSize) + (((233 & 15) + LiteralStart) << 2));
...
;
		...
		case 234:
			/* sendLiteralSelectorBytecode */
			{
				messageSelector = longAt(((((char *) method)) + BaseHeaderSize) + (((234 & 15) + LiteralStart) << 2));
...
;
		...
		case 235:
			/* sendLiteralSelectorBytecode */
			{
				messageSelector = longAt(((((char *) method)) + BaseHeaderSize) + (((235 & 15) + LiteralStart) << 2));
...
;
		...
		case 236:
			/* sendLiteralSelectorBytecode */
			{
				messageSelector = longAt(((((char *) method)) + BaseHeaderSize) + (((236 & 15) + LiteralStart) << 2));
...
;
		...
		case 237:
			/* sendLiteralSelectorBytecode */
			{
				messageSelector = longAt(((((char *) method)) + BaseHeaderSize) + (((237 & 15) + LiteralStart) << 2));
...
;
		...
		case 238:
			/* sendLiteralSelectorBytecode */
			{
				messageSelector = longAt(((((char *) method)) + BaseHeaderSize) + (((238 & 15) + LiteralStart) << 2));
...
;
		...
		case 239:
			/* sendLiteralSelectorBytecode */
			{
				messageSelector = longAt(((((char *) method)) + BaseHeaderSize) + (((239 & 15) + LiteralStart) << 2));
...
;
		...
		case 240:
			/* sendLiteralSelectorBytecode */
			{
				messageSelector = longAt(((((char *) method)) + BaseHeaderSize) + (((240 & 15) + LiteralStart) << 2));
...
;
		...
		case 241:
			/* sendLiteralSelectorBytecode */
			{
				messageSelector = longAt(((((char *) method)) + BaseHeaderSize) + (((241 & 15) + LiteralStart) << 2));
...
;
		...
		case 242:
			/* sendLiteralSelectorBytecode */
			{
				messageSelector = longAt(((((char *) method)) + BaseHeaderSize) + (((242 & 15) + LiteralStart) << 2));
...
;
		...
		case 243:
			/* sendLiteralSelectorBytecode */
			{
				messageSelector = longAt(((((char *) method)) + BaseHeaderSize) + (((243 & 15) + LiteralStart) << 2));
...
;
		...
		case 244:
			/* sendLiteralSelectorBytecode */
			{
				messageSelector = longAt(((((char *) method)) + BaseHeaderSize) + (((244 & 15) + LiteralStart) << 2));
...
;
		...
		case 245:
			/* sendLiteralSelectorBytecode */
			{
				messageSelector = longAt(((((char *) method)) + BaseHeaderSize) + (((245 & 15) + LiteralStart) << 2));
...
;
		...
		case 246:
			/* sendLiteralSelectorBytecode */
			{
				messageSelector = longAt(((((char *) method)) + BaseHeaderSize) + (((246 & 15) + LiteralStart) << 2));
...
;
		...
		case 247:
			/* sendLiteralSelectorBytecode */
			{
				messageSelector = longAt(((((char *) method)) + BaseHeaderSize) + (((247 & 15) + LiteralStart) << 2));
...
;
		...
		case 248:
			/* sendLiteralSelectorBytecode */
			{
				messageSelector = longAt(((((char *) method)) + BaseHeaderSize) + (((248 & 15) + LiteralStart) << 2));
...
;
		...
		case 249:
			/* sendLiteralSelectorBytecode */
			{
				messageSelector = longAt(((((char *) method)) + BaseHeaderSize) + (((249 & 15) + LiteralStart) << 2));
...
;
		...
		case 250:
			/* sendLiteralSelectorBytecode */
			{
				messageSelector = longAt(((((char *) method)) + BaseHeaderSize) + (((250 & 15) + LiteralStart) << 2));
...
;
		...
		case 251:
			/* sendLiteralSelectorBytecode */
			{
				messageSelector = longAt(((((char *) method)) + BaseHeaderSize) + (((251 & 15) + LiteralStart) << 2));
...
;
		...
		case 252:
			/* sendLiteralSelectorBytecode */
			{
				messageSelector = longAt(((((char *) method)) + BaseHeaderSize) + (((252 & 15) + LiteralStart) << 2));
...
;
		...
		case 253:
			/* sendLiteralSelectorBytecode */
			{
				messageSelector = longAt(((((char *) method)) + BaseHeaderSize) + (((253 & 15) + LiteralStart) << 2));
...
;
		...
		case 254:
			/* sendLiteralSelectorBytecode */
			{
				messageSelector = longAt(((((char *) method)) + BaseHeaderSize) + (((254 & 15) + LiteralStart) << 2));
...
;
		...
		case 255:
			/* sendLiteralSelectorBytecode */
			{
				messageSelector = longAt(((((char *) method)) + BaseHeaderSize) + (((255 & 15) + LiteralStart) << 2));
...
int isKindOf(int oop, char *className) {
	...
	/* begin fetchClassOf: */
	if ((oop & 1)) {
		oopClass = longAt(((((char *) specialObjectsOop)) + BaseHeaderSize) + (ClassInteger << 2));
		goto l1;
	}
	ccIndex = (((unsigned) (longAt(oop))) >> 12) & 31;
	if (ccIndex == 0) {
		...
		oopClass = longAt(((((char *) (longAt(((((char *) specialObjectsOop)) + BaseHeaderSize) + (CompactClasses << 2))))) + BaseHeaderSize) + ((ccIndex - 1) << 2));
		goto l1;
	}
l1:	/* end fetchClassOf: */;
...
int isFloatObject(int oop) {
	return (fetchClassOf(oop)) == (longAt(((((char *) specialObjectsOop)) + BaseHeaderSize) + (ClassFloat << 2)));
}
...
double loadFloatOrIntFrom(int floatOrInt) {
	...
	if ((fetchClassOfNonInt(floatOrInt)) == (longAt(((((char *) specialObjectsOop)) + BaseHeaderSize) + (ClassFloat << 2)))) {
...
int loadInitialContext(void) {
	...
	sched = longAt(((((char *) (longAt(((((char *) specialObjectsOop)) + BaseHeaderSize) + (SchedulerAssociation << 2))))) + BaseHeaderSize) + (ValueIndex << 2));
	proc = longAt(((((char *) sched)) + BaseHeaderSize) + (ActiveProcessIndex << 2));
	activeContext = longAt(((((char *) proc)) + BaseHeaderSize) + (SuspendedContextIndex << 2));
	if (activeContext < youngStart) {
		beRootIfOld(activeContext);
	}
	...
	stackPointer = (activeCntx + BaseHeaderSize) + (((TempFrameStart + tmp) - 1) * 4);
	reclaimableContextCount = 0;
}
...
int lookupMethodInClass(int class) {
	...
	while (currentClass != nilObj) {
		...
		if (dictionary == nilObj) {
			...
			remapBufferCount -= 1;
			currentClass = oop;
			messageSelector = longAt(((((char *) specialObjectsOop)) + BaseHeaderSize) + (SelectorCannotInterpret << 2));
	...
	l1:	/* end sizeBitsOf: */;
		...
		if ((messageSelector & 1)) {
			...
			index = (mask & ((((unsigned) (longAt(messageSelector))) >> 17) & 4095)) + SelectorStart;
		}
		wrapAround = 0;
		while (1) {
			...
			if (nextSelector == messageSelector) {
				...
				newMethod = longAt(((((char *) methodArray)) + BaseHeaderSize) + ((index - SelectorStart) << 2));
				if (((((unsigned) (longAt(newMethod))) >> 8) & 15) >= 12) {
					/* begin primitiveIndexOf: */
					primBits = (((unsigned) (longAt(((((char *) newMethod)) + BaseHeaderSize) + (HeaderIndex << 2)))) >> 1) & 268435967;
	...
	if (messageSelector == (longAt(((((char *) specialObjectsOop)) + BaseHeaderSize) + (SelectorDoesNotUnderstand << 2)))) {
	...
	remapBufferCount -= 1;
	rclass = oop1;
	messageSelector = longAt(((((char *) specialObjectsOop)) + BaseHeaderSize) + (SelectorDoesNotUnderstand << 2));
...
int okayFields(int oop) {
	...
	/* begin fetchClassOf: */
	if ((oop & 1)) {
		c = longAt(((((char *) specialObjectsOop)) + BaseHeaderSize) + (ClassInteger << 2));
		goto l1;
	}
	ccIndex = (((unsigned) (longAt(oop))) >> 12) & 31;
	if (ccIndex == 0) {
		...
		c = longAt(((((char *) (longAt(((((char *) specialObjectsOop)) + BaseHeaderSize) + (CompactClasses << 2))))) + BaseHeaderSize) + ((ccIndex - 1) << 2));
		goto l1;
	}
l1:	/* end fetchClassOf: */;
	if ((c == (longAt(((((char *) specialObjectsOop)) + BaseHeaderSize) + (ClassMethodContext << 2)))) || (c == (longAt(((((char *) specialObjectsOop)) + BaseHeaderSize) + (ClassBlockContext << 2))))) {
...
int positive32BitIntegerFor(int integerValue) {
	...
	newLargeInteger = instantiateSmallClasssizeInBytesfill(longAt(((((char *) specialObjectsOop)) + BaseHeaderSize) + (ClassLargePositiveInteger << 2)), 8, 0);
...
int positive32BitValueOf(int oop) {
	...
	/* begin success: */
	successFlag = (cl == (longAt(((((char *) specialObjectsOop)) + BaseHeaderSize) + (ClassLargePositiveInteger << 2)))) && successFlag;
...
int positive64BitIntegerFor(squeakInt64 integerValue) {
	...
	newLargeInteger = instantiateSmallClasssizeInBytesfill(longAt(((((char *) specialObjectsOop)) + BaseHeaderSize) + (ClassLargePositiveInteger << 2)), 12, 0);
	for (i = 0; i <= 7; i += 1) {
...
int primitiveAtEnd(void) {
	...
	stackPointer -= 4;
	stream = top;
	successFlag = (((stream & 1) == 0) && (((((unsigned) (longAt(stream))) >> 8) & 15) <= 4)) && ((lengthOf(stream)) >= (StreamReadLimitIndex + 1));
	if (successFlag) {
...
int primitiveBytesLeft(void) {
	...
	if (argumentCount == 0) {
		...
		/* begin pushInteger: */
		/* begin push: */
		longAtput(sp = stackPointer + 4, ((((longAt(freeBlock)) & AllButTypeMask) << 1) | 1));
		stackPointer = sp;
		return null;
	}
	if (argumentCount == 1) {
	...
	l1:	/* end booleanValueOf: */;
		...
		stackPointer -= 2 * 4;
		/* begin pushInteger: */
		integerValue = ((longAt(freeBlock)) & AllButTypeMask) + (sqMemoryExtraBytesLeft(aBool));
		/* begin push: */
...
l2:	/* end stackObjectValue: */;
	...
	/* begin fetchClassOf: */
	if ((arg & 1)) {
		argClass = longAt(((((char *) specialObjectsOop)) + BaseHeaderSize) + (ClassInteger << 2));
		goto l3;
	}
	...
	if (ccIndex1 == 0) {
		...
		argClass = longAt(((((char *) (longAt(((((char *) specialObjectsOop)) + BaseHeaderSize) + (CompactClasses << 2))))) + BaseHeaderSize) + ((ccIndex1 - 1) << 2));
		goto l3;
	}
l3:	/* end fetchClassOf: */;
...
l1:	/* end fetchClassOf: */;
	longAtput(sp = stackPointer - (((argumentCount + 1) - 1) * 4), oop);
	stackPointer = sp;
}
...
int primitiveClipboardText(void) {
	...
	if (argumentCount == 1) {
		...
		sz = clipboardSize();
		s = instantiateClassindexableSize(longAt(((((char *) specialObjectsOop)) + BaseHeaderSize) + (ClassString << 2)), sz);
...
int primitiveClosureValue(void) {
	...
	blockClosure = longAt(stackPointer - (argumentCount * 4));
	newMethod = longAt(((((char *) blockClosure)) + BaseHeaderSize) + (BlockMethodIndex << 2));
	/* begin primitiveIndexOf: */
	primBits = (((unsigned) (longAt(((((char *) newMethod)) + BaseHeaderSize) + (HeaderIndex << 2)))) >> 1) & 268435967;
	primitiveIndex = (primBits & 511) + (((unsigned) primBits) >> 19);
	/* begin success: */
	successFlag = (argumentCount == ((((unsigned) (longAt(((((char *) newMethod)) + BaseHeaderSize) + (HeaderIndex << 2)))) >> 25) & 15)) && successFlag;
	if (successFlag) {
		...
		for (i = 0; i <= argumentCount; i += 1) {
			longAtput(where + ((ReceiverIndex + i) << 2), longAt(stackPointer - ((argumentCount - i) * 4)));
		}
		nilOop = nilObj;
		...
		instructionPointer = ((method + tmp) + BaseHeaderSize) - 2;
		tmp = ((longAt(((((char *) newContext)) + BaseHeaderSize) + (StackPointerIndex << 2))) >> 1);
		stackPointer = (newContext + BaseHeaderSize) + (((TempFrameStart + tmp) - 1) * 4);
...
int primitiveClosureValueWithArgs(void) {
	...
	blockClosure = longAt(stackPointer - (1 * 4));
	/* begin push: */
	longAtput(sp = stackPointer + 4, longAt(((((char *) blockClosure)) + BaseHeaderSize) + (BlockMethodIndex << 2)));
	stackPointer = sp;
	...
	primBits = (((unsigned) (longAt(((((char *) newMethod)) + BaseHeaderSize) + (HeaderIndex << 2)))) >> 1) & 268435967;
	primitiveIndex = (primBits & 511) + (((unsigned) primBits) >> 19);
	argCnt = (((unsigned) (longAt(((((char *) newMethod)) + BaseHeaderSize) + (HeaderIndex << 2)))) >> 25) & 15;
	/* begin popStack */
	top1 = longAt(stackPointer);
	stackPointer -= 4;
	argumentArray = top1;
	...
	if (successFlag) {
		...
		lastIn = in + (argCnt * 4);
		out = (stackPointer + 4) - 4;
		while (in < lastIn) {
			longAtput(out += 4, longAt(in += 4));
		}
		/* begin unPop: */
		stackPointer += argCnt * 4;
...
int primitiveDiv(void) {
	...
	quotient = doPrimitiveDivby(longAt(stackPointer - (1 * 4)), longAt(stackPointer));
	/* begin pop2AndPushIntegerIfOK: */
	if (successFlag) {
...
l3:	/* end sizeBitsOf: */;
	...
	/* begin success: */
	successFlag = (((((unsigned) ((stackPointer - activeContext) - BaseHeaderSize)) >> 2) + arraySize) < cntxSize) && successFlag;
	if (!(((argumentArray & 1) == 0) && (((((unsigned) (longAt(argumentArray))) >> 8) & 15) == 2))) {
		/* begin primitiveFail */
		successFlag = 0;
		return null;
...
l1:	/* end stackIntegerValue: */;
	...
	while (index <= argumentCount) {
		/* begin push: */
		longAtput(sp = stackPointer + 4, longAt(((((char *) argumentArray)) + BaseHeaderSize) + ((index - 1) << 2)));
		stackPointer = sp;
		index += 1;
	}
	/* begin pushRemappableOop: */
...
int primitiveExternalCall(void) {
	...
	/* begin success: */
	successFlag = (((((unsigned) (longAt(((((char *) newMethod)) + BaseHeaderSize) + (HeaderIndex << 2)))) >> 10) & 255) > 0) && successFlag;
	if (!(successFlag)) {
		return null;
	}
	...
	lit = longAt(((((char *) newMethod)) + BaseHeaderSize) + ((0 + LiteralStart) << 2));
	/* begin success: */
		...
		if (addr != 0) {
			...
			if (timerPending) {
				if ((ioLowResMSecs()) != startTime) {
					if (((ioMSecs()) & MillisecondClockMask) >= nextWakeupTick) {
						if (successFlag) {
							checkForInterrupts();
						} else {
							/* begin forceInterruptCheck */
...
l1:	/* end checkedIntegerValueOf: */;
	...
	if (successFlag) {
		...
		/* begin pop:thenPush: */
		longAtput(sp = stackPointer - ((2 - 1) * 4), s);
		stackPointer = sp;
	}
}
...
int primitiveInputSemaphore(void) {
	...
	stackPointer -= 4;
	arg = top;
	if ((fetchClassOf(arg)) == (longAt(((((char *) specialObjectsOop)) + BaseHeaderSize) + (ClassSemaphore << 2)))) {
		/* begin storePointer:ofObject:withValue: */
		oop = specialObjectsOop;
		if (oop < youngStart) {
...
l2:	/* end checkedIntegerValueOf: */;
	...
	if (successFlag) {
		/* begin pop:thenPush: */
		longAtput(sp = stackPointer - (((argumentCount + 1) - 1) * 4), newValue);
		stackPointer = sp;
	}
}
...
int primitiveInstVarsPutFromStack(void) {
	...
	for (i = 0; i <= (argumentCount - 1); i += 1) {
		if ((i & 3) == 0) {
			offsetBits = positive32BitValueOf(longAt(((((char *) newMethod)) + BaseHeaderSize) + (((((int) i >> 2)) + LiteralStart) << 2)));
		}
		longAtput(((((char *) rcvr)) + BaseHeaderSize) + ((offsetBits & 255) << 2), longAt(stackPointer - (i * 4)));
...
int primitiveInvokeObjectAsMethod(void) {
	...
	runArgs = instantiateClassindexableSize(longAt(((((char *) specialObjectsOop)) + BaseHeaderSize) + (ClassArray << 2)), argumentCount);
	beRootIfOld(runArgs);
	/* begin transfer:from:to: */
	in = (stackPointer - ((argumentCount - 1) * 4)) - 4;
	lastIn = in + (argumentCount * 4);
	...
	runReceiver = longAt(stackPointer - (argumentCount * 4));
	/* begin pop: */
	stackPointer -= (argumentCount + 1) * 4;
	newReceiver = newMethod;
	messageSelector = longAt(((((char *) specialObjectsOop)) + BaseHeaderSize) + (SelectorRunWithIn << 2));
	argumentCount = 3;
	/* begin push: */
	longAtput(sp = stackPointer + 4, newReceiver);
	stackPointer = sp;
	/* begin push: */
	longAtput(sp1 = stackPointer + 4, runSelector);
	stackPointer = sp1;
	/* begin push: */
	longAtput(sp2 = stackPointer + 4, runArgs);
	stackPointer = sp2;
	/* begin push: */
	longAtput(sp3 = stackPointer + 4, runReceiver);
	stackPointer = sp3;
	/* begin fetchClassOf: */
	if ((newReceiver & 1)) {
		lookupClass = longAt(((((char *) specialObjectsOop)) + BaseHeaderSize) + (ClassInteger << 2));
		goto l2;
	}
	...
	if (ccIndex == 0) {
		...
		lookupClass = longAt(((((char *) (longAt(((((char *) specialObjectsOop)) + BaseHeaderSize) + (CompactClasses << 2))))) + BaseHeaderSize) + ((ccIndex - 1) << 2));
		goto l2;
	}
l2:	/* end fetchClassOf: */;
...
l1:	/* end stackIntegerValue: */;
	...
	nameOop = instantiateClassindexableSize(longAt(((((char *) specialObjectsOop)) + BaseHeaderSize) + (ClassString << 2)), length);
	for (i = 0; i <= (length - 1); i += 1) {
	...
	interruptCheckCounter = -1000;
	/* begin pop:thenPush: */
	longAtput(sp1 = stackPointer - ((2 - 1) * 4), nameOop);
	stackPointer = sp1;
}
...
int primitiveLoadImageSegment(void) {
	...
	/* begin pop:thenPush: */
	longAtput(sp = stackPointer - ((3 - 1) * 4), ((segmentWordArray + BaseHeaderSize) + 4) + (headerTypeBytes[(longAt((segmentWordArray + BaseHeaderSize) + 4)) & TypeMask]));
	stackPointer = sp;
}
...
int primitiveLoadInstVar(void) {
	...
	thisReceiver = top;
	/* begin push: */
	longAtput(sp = stackPointer + 4, longAt(((((char *) thisReceiver)) + BaseHeaderSize) + ((primitiveIndex - 264) << 2)));
	stackPointer = sp;
}
...
int primitiveMod(void) {
	...
	mod = doPrimitiveModby(longAt(stackPointer - (1 * 4)), longAt(stackPointer));
	/* begin pop2AndPushIntegerIfOK: */
	if (successFlag) {
		if ((mod ^ (mod << 1)) >= 0) {
			/* begin pop:thenPush: */
...
int primitiveNew(void) {
	...
	if (format < 8) {
		/* begin sufficientSpaceToAllocate: */
		minFree = (lowSpaceThreshold + (2500 + (0 * 4))) + BaseHeaderSize;
		if ((((unsigned ) ((longAt(freeBlock)) & AllButTypeMask))) >= (((unsigned ) minFree))) {
			okay = 1;
			goto l1;
		} else {
	...
	l1:	/* end sufficientSpaceToAllocate: */;
		...
		if ((((unsigned ) ((longAt(freeBlock)) & AllButTypeMask))) >= (((unsigned ) minFree1))) {
			okay = 1;
			goto l2;
		} else {
...
int primitiveNewWithArg(void) {
	...
	if (successFlag) {
		...
		if (format < 8) {
			/* begin sufficientSpaceToAllocate: */
			minFree = (lowSpaceThreshold + (2500 + (size * 4))) + BaseHeaderSize;
			if ((((unsigned ) ((longAt(freeBlock)) & AllButTypeMask))) >= (((unsigned ) minFree))) {
				okay = 1;
				goto l1;
			} else {
...
int primitiveNextInstance(void) {
	...
	/* begin fetchClassOf: */
	if ((object & 1)) {
		classPointer = longAt(((((char *) specialObjectsOop)) + BaseHeaderSize) + (ClassInteger << 2));
		goto l3;
	}
	...
	if (ccIndex1 == 0) {
		...
		classPointer = longAt(((((char *) (longAt(((((char *) specialObjectsOop)) + BaseHeaderSize) + (CompactClasses << 2))))) + BaseHeaderSize) + ((ccIndex1 - 1) << 2));
		goto l3;
	}
l3:	/* end fetchClassOf: */;
	...
	while (!(thisObj == null)) {
		/* begin fetchClassOf: */
		if ((thisObj & 1)) {
			thisClass = longAt(((((char *) specialObjectsOop)) + BaseHeaderSize) + (ClassInteger << 2));
			goto l2;
		}
		...
		if (ccIndex == 0) {
			...
			thisClass = longAt(((((char *) (longAt(((((char *) specialObjectsOop)) + BaseHeaderSize) + (CompactClasses << 2))))) + BaseHeaderSize) + ((ccIndex - 1) << 2));
			goto l2;
		}
	l2:	/* end fetchClassOf: */;
...
l1:	/* end instanceAfter: */;
	if (instance == nilObj) {
		...
		/* begin pop:thenPush: */
		longAtput(sp = stackPointer - (((argumentCount + 1) - 1) * 4), instance);
		stackPointer = sp;
	}
}
...
int primitiveNextObject(void) {
	...
	if (instance == null) {
		...
		/* begin pop:thenPush: */
		longAtput(sp1 = stackPointer - (((argumentCount + 1) - 1) * 4), instance);
		stackPointer = sp1;
	}
}
...
l1:	/* end popInteger */;
	...
	successFlag = (index > 0) && successFlag;
	/* begin success: */
	successFlag = (index <= (((((unsigned) (longAt(((((char *) thisReceiver)) + BaseHeaderSize) + (HeaderIndex << 2)))) >> 10) & 255) + LiteralStart)) && successFlag;
	if (successFlag) {
		/* begin push: */
		longAtput(sp = stackPointer + 4, longAt(((((char *) thisReceiver)) + BaseHeaderSize) + ((index - 1) << 2)));
		stackPointer = sp;
	} else {
		/* begin unPop: */
		stackPointer += 2 * 4;
...
int primitivePerform(void) {
	...
	argumentCount -= 1;
	selectorIndex = (((unsigned) ((stackPointer - activeContext) - BaseHeaderSize)) >> 2) - argumentCount;
...
l2:	/* end fetchClassOf: */;
	...
	if (((((unsigned) (longAt(newMethod))) >> 8) & 15) >= 12) {
		/* begin success: */
		successValue = ((((unsigned) (longAt(((((char *) newMethod)) + BaseHeaderSize) + (HeaderIndex << 2)))) >> 25) & 15) == argumentCount;
		successFlag = successValue && successFlag;
	}
	if (successFlag) {
		/* begin executeNewMethod */
		...
		for (i1 = 0; i1 <= argumentCount; i1 += 1) {
			longAtput(where + ((ReceiverIndex + i1) << 2), longAt(stackPointer - ((argumentCount - i1) * 4)));
		}
		nilOop = nilObj;
		for (i1 = ((argumentCount + 1) + ReceiverIndex); i1 <= (tempCount + ReceiverIndex); i1 += 1) {
	...
	l1:	/* end executeNewMethod */;
		...
		for (i = 1; i <= argumentCount; i += 1) {
			...
			oop = activeContext;
			valuePointer = longAt(((((char *) activeContext)) + BaseHeaderSize) + (((argumentCount - i) + selectorIndex) << 2));
			if (oop < youngStart) {
				possibleRootStoreIntovalue(oop, valuePointer);
			}
...
int primitivePerformAt(int lookupClass) {
	...
	l1:	/* end sizeBitsOf: */;
		...
		if ((header1 & TypeMask) == HeaderTypeSizeAndClass) {
			sz1 = (longAt(activeContext - 8)) & AllButTypeMask;
			goto l2;
		} else {
			sz1 = header1 & SizeMask;
			goto l2;
	...
	if (((((unsigned) (longAt(newMethod))) >> 8) & 15) >= 12) {
		/* begin success: */
		successFlag = (((((unsigned) (longAt(((((char *) newMethod)) + BaseHeaderSize) + (HeaderIndex << 2)))) >> 25) & 15) == argumentCount) && successFlag;
	}
	if (successFlag) {
		/* begin executeNewMethod */
		if (primitiveIndex > 0) {
...
int primitivePerformInSuperclass(void) {
	...
	/* begin fetchClassOf: */
	if ((rcvr & 1)) {
		currentClass = longAt(((((char *) specialObjectsOop)) + BaseHeaderSize) + (ClassInteger << 2));
		goto l1;
	}
	ccIndex = (((unsigned) (longAt(rcvr))) >> 12) & 31;
	if (ccIndex == 0) {
		...
		currentClass = longAt(((((char *) (longAt(((((char *) specialObjectsOop)) + BaseHeaderSize) + (CompactClasses << 2))))) + BaseHeaderSize) + ((ccIndex - 1) << 2));
		goto l1;
	}
l1:	/* end fetchClassOf: */;
...
int primitivePushMinusOne(void) {
	...
	stackPointer -= 4;
	/* begin push: */
	longAtput(sp = stackPointer + 4, ConstMinusOne);
	stackPointer = sp;
}
...
int primitivePushOne(void) {
	...
	stackPointer -= 4;
	/* begin push: */
	longAtput(sp = stackPointer + 4, ConstOne);
	stackPointer = sp;
}
...
int primitivePushTwo(void) {
	...
	stackPointer -= 4;
	/* begin push: */
	longAtput(sp = stackPointer + 4, ConstTwo);
	stackPointer = sp;
}
...
int primitivePushZero(void) {
	...
	stackPointer -= 4;
	/* begin push: */
	longAtput(sp = stackPointer + 4, ConstZero);
	stackPointer = sp;
}
...
l7:	/* end stackObjectValue: */;
	...
	while (scanLastIndex <= scanStopIndex) {
		...
		if (nextDestX > scanRightX) {
			...
			stackPointer -= 7 * 4;
			/* begin push: */
			longAtput(sp1 = stackPointer + 4, longAt(((((char *) stops)) + BaseHeaderSize) + ((CrossedX - 1) << 2)));
			stackPointer = sp1;
			return null;
		}
	...
	stackPointer -= 7 * 4;
	/* begin push: */
	longAtput(sp2 = stackPointer + 4, longAt(((((char *) stops)) + BaseHeaderSize) + ((EndOfRun - 1) << 2)));
	stackPointer = sp2;
	return null;
}
...
l4:	/* end checkedIntegerValueOf: */;
	displayBitsOfLeftTopRightBottom(longAt(((((char *) specialObjectsOop)) + BaseHeaderSize) + (TheDisplay << 2)), left, top, right, bottom);
	if (successFlag) {
		ioForceDisplayUpdate();
		/* begin pop: */
		stackPointer -= 4 * 4;
...
int primitiveSignal(void) {
	...
	/* begin success: */
	successFlag = (cl == (longAt(((((char *) specialObjectsOop)) + BaseHeaderSize) + (ClassSemaphore << 2)))) && successFlag;
l1:	/* end assertClassOf:is: */;
	if (successFlag) {
		synchronousSignal(sema);
	}
...
int primitiveSpecialObjectsOop(void) {
	...
	/* begin pop:thenPush: */
	longAtput(sp = stackPointer - ((1 - 1) * 4), specialObjectsOop);
	stackPointer = sp;
}
...
l2:	/* end checkedIntegerValueOf: */;
	...
	/* begin success: */
	successFlag = (newStackp <= ((((int) (LargeContextSize - BaseHeaderSize) >> 2)) - CtxtTempFrameStart)) && successFlag;
	if (!(successFlag)) {
		/* begin primitiveFail */
		successFlag = 0;
		return null;
...
l6:	/* end lengthOf:baseHeader:format: */;
	...
	/* begin fetchClassOf: */
	if ((repl & 1)) {
		class1 = longAt(((((char *) specialObjectsOop)) + BaseHeaderSize) + (ClassInteger << 2));
		goto l9;
	}
	...
	if (ccIndex1 == 0) {
		...
		class1 = longAt(((((char *) (longAt(((((char *) specialObjectsOop)) + BaseHeaderSize) + (CompactClasses << 2))))) + BaseHeaderSize) + ((ccIndex1 - 1) << 2));
		goto l9;
	}
l9:	/* end fetchClassOf: */;
...
int primitiveSuspend(void) {
	...
	activeProc = longAt(((((char *) (longAt(((((char *) (longAt(((((char *) specialObjectsOop)) + BaseHeaderSize) + (SchedulerAssociation << 2))))) + BaseHeaderSize) + (ValueIndex << 2))))) + BaseHeaderSize) + (ActiveProcessIndex << 2));
	/* begin success: */
...
int primitiveVMParameter(void) {
	...
	if (argumentCount == 0) {
		paramsArraySize = 25;
		result = instantiateClassindexableSize(longAt(((((char *) specialObjectsOop)) + BaseHeaderSize) + (ClassArray << 2)), paramsArraySize);
		for (i = 0; i <= (paramsArraySize - 1); i += 1) {
			longAtput(((((char *) result)) + BaseHeaderSize) + (i << 2), ConstZero);
		}
		longAtput(((((char *) result)) + BaseHeaderSize) + (0 << 2), (((youngStart - mem) << 1) | 1));
		longAtput(((((char *) result)) + BaseHeaderSize) + (1 << 2), (((freeBlock - mem) << 1) | 1));
		longAtput(((((char *) result)) + BaseHeaderSize) + (2 << 2), (((endOfMemory - mem) << 1) | 1));
		longAtput(((((char *) result)) + BaseHeaderSize) + (3 << 2), ((allocationCount << 1) | 1));
		longAtput(((((char *) result)) + BaseHeaderSize) + (4 << 2), ((allocationsBetweenGCs << 1) | 1));
		longAtput(((((char *) result)) + BaseHeaderSize) + (5 << 2), ((tenuringThreshold << 1) | 1));
		longAtput(((((char *) result)) + BaseHeaderSize) + (6 << 2), ((statFullGCs << 1) | 1));
		longAtput(((((char *) result)) + BaseHeaderSize) + (7 << 2), ((statFullGCMSecs << 1) | 1));
		longAtput(((((char *) result)) + BaseHeaderSize) + (8 << 2), ((statIncrGCs << 1) | 1));
		longAtput(((((char *) result)) + BaseHeaderSize) + (9 << 2), ((statIncrGCMSecs << 1) | 1));
		longAtput(((((char *) result)) + BaseHeaderSize) + (10 << 2), ((statTenures << 1) | 1));
		longAtput(((((char *) result)) + BaseHeaderSize) + (20 << 2), ((rootTableCount << 1) | 1));
		longAtput(((((char *) result)) + BaseHeaderSize) + (21 << 2), ((statRootTableOverflows << 1) | 1));
		longAtput(((((char *) result)) + BaseHeaderSize) + (22 << 2), ((extraVMMemory << 1) | 1));
		longAtput(((((char *) result)) + BaseHeaderSize) + (23 << 2), ((shrinkThreshold << 1) | 1));
		longAtput(((((char *) result)) + BaseHeaderSize) + (24 << 2), ((growHeadroom << 1) | 1));
		/* begin pop:thenPush: */
		longAtput(sp = stackPointer - ((1 - 1) * 4), result);
		stackPointer = sp;
		return null;
...
l1:	/* end checkedIntegerValueOf: */;
	/* begin success: */
	successValue = (argumentCount == blockArgumentCount) && ((longAt(((((char *) blockContext)) + BaseHeaderSize) + (CallerIndex << 2))) == nilObj);
	successFlag = successValue && successFlag;
	if (successFlag) {
		/* begin transfer:fromIndex:ofObject:toIndex:ofObject: */
		fromIndex = activeContext + ((((((unsigned) ((stackPointer - activeContext) - BaseHeaderSize)) >> 2) - argumentCount) + 1) * 4);
		...
		/* begin storeStackPointerValue:inContext: */
		longAtput(((((char *) blockContext)) + BaseHeaderSize) + (StackPointerIndex << 2), ((argumentCount << 1) | 1));
		longAtput(((((char *) blockContext)) + BaseHeaderSize) + (CallerIndex << 2), activeContext);
		/* begin newActiveContext: */
		/* begin storeContextRegisters: */
		longAtput(((((char *) activeContext)) + BaseHeaderSize) + (InstructionPointerIndex << 2), ((((instructionPointer - method) - (BaseHeaderSize - 2)) << 1) | 1));
		longAtput(((((char *) activeContext)) + BaseHeaderSize) + (StackPointerIndex << 2), (((((((unsigned) ((stackPointer - activeContext) - BaseHeaderSize)) >> 2) - TempFrameStart) + 1) << 1) | 1));
		...
		stackPointer = (blockContext + BaseHeaderSize) + (((TempFrameStart + tmp) - 1) * 4);
	}
}
...
l2:	/* end argumentCountOfBlock: */;
	...
	l1:	/* end sizeBitsOf: */;
		...
		/* begin success: */
		successValue = (arrayArgumentCount == blockArgumentCount) && ((longAt(((((char *) blockContext)) + BaseHeaderSize) + (CallerIndex << 2))) == nilObj);
		successFlag = successValue && successFlag;
	}
	if (successFlag) {
		/* begin transfer:fromIndex:ofObject:toIndex:ofObject: */
...
l1:	/* end assertClassOf:is: */;
	if (successFlag) {
		...
		if (excessSignals > 0) {
			...
			if ((longAt(((((char *) sema)) + BaseHeaderSize) + (FirstLinkIndex << 2))) == nilObj) {
				/* begin storePointer:ofObject:withValue: */
				if (sema < youngStart) {
...
int primitiveYield(void) {
	...
	processLists = longAt(((((char *) (longAt(((((char *) (longAt(((((char *) specialObjectsOop)) + BaseHeaderSize) + (SchedulerAssociation << 2))))) + BaseHeaderSize) + (ValueIndex << 2))))) + BaseHeaderSize) + (ProcessListsIndex << 2));
	processList = longAt(((((char *) processLists)) + BaseHeaderSize) + ((priority - 1) << 2));
	if (!((longAt(((((char *) processList)) + BaseHeaderSize) + (FirstLinkIndex << 2))) == nilObj)) {
		/* begin addLastLink:toList: */
		if ((longAt(((((char *) processList)) + BaseHeaderSize) + (FirstLinkIndex << 2))) == nilObj) {
			/* begin storePointer:ofObject:withValue: */
...
int printAllStacks(void) {
	...
	proc = longAt(((((char *) (longAt(((((char *) (longAt(((((char *) specialObjectsOop)) + BaseHeaderSize) + (SchedulerAssociation << 2))))) + BaseHeaderSize) + (ValueIndex << 2))))) + BaseHeaderSize) + (ActiveProcessIndex << 2));
	...
	oop = chunk + (headerTypeBytes[(longAt(chunk)) & TypeMask]);
	while (oop < endOfMemory) {
		if ((fetchClassOf(oop)) == (longAt(((((char *) specialObjectsOop)) + BaseHeaderSize) + (ClassSemaphore << 2)))) {
			/* begin cr */
			printf("\n");
...
int printCallStackOf(int aContext) {
	...
	ctxt = aContext;
	while (!(ctxt == nilObj)) {
		if ((fetchClassOf(ctxt)) == (longAt(((((char *) specialObjectsOop)) + BaseHeaderSize) + (ClassBlockContext << 2)))) {
	...
	l2:	/* end fetchClassOf: */;
		...
		/* begin fetchClassOf: */
		if (((longAt(((((char *) home)) + BaseHeaderSize) + (ReceiverIndex << 2))) & 1)) {
			methClass = longAt(((((char *) specialObjectsOop)) + BaseHeaderSize) + (ClassInteger << 2));
			goto l3;
		}
		...
		if (ccIndex1 == 0) {
			...
			methClass = longAt(((((char *) (longAt(((((char *) specialObjectsOop)) + BaseHeaderSize) + (CompactClasses << 2))))) + BaseHeaderSize) + ((ccIndex1 - 1) << 2));
			goto l3;
		}
		methClass = null;
	l3:	/* end findClassOfMethod:forReceiver: */;
		...
		/* begin fetchClassOf: */
		if (((longAt(((((char *) home)) + BaseHeaderSize) + (ReceiverIndex << 2))) & 1)) {
			currClass1 = longAt(((((char *) specialObjectsOop)) + BaseHeaderSize) + (ClassInteger << 2));
			goto l5;
		}
		...
		if (ccIndex2 == 0) {
			...
			currClass1 = longAt(((((char *) (longAt(((((char *) specialObjectsOop)) + BaseHeaderSize) + (CompactClasses << 2))))) + BaseHeaderSize) + ((ccIndex2 - 1) << 2));
			goto l5;
		}
	l5:	/* end fetchClassOf: */;
		done1 = 0;
	...
	l6:	/* end findSelectorOfMethod:forReceiver: */;
		...
		if (methodSel == (longAt(((((char *) specialObjectsOop)) + BaseHeaderSize) + (SelectorDoesNotUnderstand << 2)))) {
...
int resume(int aProcess) {
	...
	if (newPriority > activePriority) {
		...
		processLists1 = longAt(((((char *) (longAt(((((char *) (longAt(((((char *) specialObjectsOop)) + BaseHeaderSize) + (SchedulerAssociation << 2))))) + BaseHeaderSize) + (ValueIndex << 2))))) + BaseHeaderSize) + (ProcessListsIndex << 2));
		processList1 = longAt(((((char *) processLists1)) + BaseHeaderSize) + ((priority1 - 1) << 2));
		/* begin addLastLink:toList: */
		if ((longAt(((((char *) processList1)) + BaseHeaderSize) + (FirstLinkIndex << 2))) == nilObj) {
			/* begin storePointer:ofObject:withValue: */
...
int signed32BitIntegerFor(int integerValue) {
	...
	if (integerValue < 0) {
		largeClass = longAt(((((char *) specialObjectsOop)) + BaseHeaderSize) + (ClassLargeNegativeInteger << 2));
		value = 0 - integerValue;
	} else {
		largeClass = longAt(((((char *) specialObjectsOop)) + BaseHeaderSize) + (ClassLargePositiveInteger << 2));
		value = integerValue;
	}
...
int signed32BitValueOf(int oop) {
	...
	/* begin fetchClassOf: */
	if ((oop & 1)) {
		largeClass = longAt(((((char *) specialObjectsOop)) + BaseHeaderSize) + (ClassInteger << 2));
		goto l1;
	}
	ccIndex = (((unsigned) (longAt(oop))) >> 12) & 31;
	if (ccIndex == 0) {
		...
		largeClass = longAt(((((char *) (longAt(((((char *) specialObjectsOop)) + BaseHeaderSize) + (CompactClasses << 2))))) + BaseHeaderSize) + ((ccIndex - 1) << 2));
		goto l1;
	}
l1:	/* end fetchClassOf: */;
	if (largeClass == (longAt(((((char *) specialObjectsOop)) + BaseHeaderSize) + (ClassLargePositiveInteger << 2)))) {
		negative = 0;
	} else {
		if (largeClass == (longAt(((((char *) specialObjectsOop)) + BaseHeaderSize) + (ClassLargeNegativeInteger << 2)))) {
			negative = 1;
		} else {
			/* begin primitiveFail */
			successFlag = 0;
...
int splObj(int index) {
	return longAt(((((char *) specialObjectsOop)) + BaseHeaderSize) + (index << 2));
}
...
double stackFloatValue(int offset) {
	...
	if (!((fetchClassOf(floatPointer)) == (longAt(((((char *) specialObjectsOop)) + BaseHeaderSize) + (ClassFloat << 2))))) {
		/* begin primitiveFail */
		successFlag = 0;
		return 0.0;
	}
...
int sufficientSpaceAfterGC(int minFree) {
	...
	if ((((unsigned ) ((longAt(freeBlock)) & AllButTypeMask))) < (((unsigned ) minFree))) {
		...
		fullGC();
		if ((((unsigned ) ((longAt(freeBlock)) & AllButTypeMask))) >= ((((unsigned ) minFree)) + 15000)) {
			return 1;
		}
...
int synchronousSignal(int aSemaphore) {
	...
	if ((longAt(((((char *) aSemaphore)) + BaseHeaderSize) + (FirstLinkIndex << 2))) == nilObj) {
...
int transferTo(int aProc) {
	...
	if (compilerInitialized) {
		...
		longAtput(((((char *) activeContext)) + BaseHeaderSize) + (InstructionPointerIndex << 2), ((((instructionPointer - method) - (BaseHeaderSize - 2)) << 1) | 1));
		longAtput(((((char *) activeContext)) + BaseHeaderSize) + (StackPointerIndex << 2), (((((((unsigned) ((stackPointer - activeContext) - BaseHeaderSize)) >> 2) - TempFrameStart) + 1) << 1) | 1));
		if ((longAt(((((char *) newProc)) + BaseHeaderSize) + (SuspendedContextIndex << 2))) < youngStart) {
			beRootIfOld(longAt(((((char *) newProc)) + BaseHeaderSize) + (SuspendedContextIndex << 2)));
		}
		activeContext = longAt(((((char *) newProc)) + BaseHeaderSize) + (SuspendedContextIndex << 2));
		/* begin fetchContextRegisters: */
		...
		stackPointer = ((longAt(((((char *) newProc)) + BaseHeaderSize) + (SuspendedContextIndex << 2))) + BaseHeaderSize) + (((TempFrameStart + tmp) - 1) * 4);
		/* begin storePointer:ofObject:withValue: */
		valuePointer1 = nilObj;
...
int wakeHighestPriority(void) {
	...
	schedLists = longAt(((((char *) (longAt(((((char *) (longAt(((((char *) specialObjectsOop)) + BaseHeaderSize) + (SchedulerAssociation << 2))))) + BaseHeaderSize) + (ValueIndex << 2))))) + BaseHeaderSize) + (ProcessListsIndex << 2));
	/* begin fetchWordLengthOf: */
	/* begin sizeBitsOf: */
...
l1:	/* end sizeBitsOf: */;
	...
	while ((longAt(((((char *) processList)) + BaseHeaderSize) + (FirstLinkIndex << 2))) == nilObj) {
		p -= 1;
		if (p < 0) {
